pub type NVMeSMARTMetrics = crate::storage_controller_metrics::v1_1_0::NVMeSMARTMetrics;
pub type StorageControllerMetrics =
    crate::storage_controller_metrics::v1_1_0::StorageControllerMetrics;
pub mod v1_0_3 {
...
pub mod v1_1_0 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::storage_controller_metrics::v1_1_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct EGCriticalWarningSummary {
        #[serde(
    ...
    pub struct NVMeSMARTMetrics {
        ...
        pub eg_critical_warning_summary:
            Option<crate::storage_controller_metrics::v1_1_0::EGCriticalWarningSummary>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "HostReadCommands")]
        pub host_read_commands: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "HostWriteCommands")]
        pub host_write_commands: Option<i64>,
    ...
    pub struct StorageControllerMetrics {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::storage_controller_metrics::v1_1_0::Actions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "CorrectableECCErrorCount"
        )]
        ...
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description:
            Option<crate::storage_controller_metrics::v1_1_0::StorageControllerMetricsDescription>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(
            skip_serializing_if = "Option::is_none",
    ...
    #[serde(untagged)]
    pub enum StorageControllerMetricsDescription {
        V000001(crate::storage_controller_metrics::v1_1_0::StorageControllerMetricsDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for StorageControllerMetricsDescription {
        fn default() -> Self {

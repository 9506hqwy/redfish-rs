...
pub enum AggregationSource {
    V010301(crate::aggregation_source::v1_3_1::AggregationSource),
    V010201(crate::aggregation_source::v1_2_1::AggregationSource),
    V010101(crate::aggregation_source::v1_1_1::AggregationSource),
    V010001(crate::aggregation_source::v1_0_1::AggregationSource),
...
pub mod v1_0_1 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::aggregation_source::v1_0_1::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct AggregationSource {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::aggregation_source::v1_0_1::Actions>,
        ...
        pub links: Option<crate::aggregation_source::v1_0_1::Links>,
        #[serde(rename = "Name")]
        pub name: String,
...
pub mod v1_1_1 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::aggregation_source::v1_1_1::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct AggregationSource {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::aggregation_source::v1_1_1::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "HostName")]
        pub host_name: Option<String>,
        ...
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::aggregation_source::v1_1_1::Links>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,
        ...
        pub snmp: Option<crate::aggregation_source::v1_1_1::SNMPSettings>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "UserName")]
        pub user_name: Option<String>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct SNMPSettings {
        ...
        pub authentication_protocol:
            Option<crate::aggregation_source::v1_1_1::SNMPAuthenticationProtocols>,
        ...
        pub encryption_protocol: Option<crate::aggregation_source::v1_1_1::SNMPEncryptionProtocols>,
    }
}
pub mod v1_2_1 {
    use serde::{Deserialize, Serialize};
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::aggregation_source::v1_2_1::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct AggregationSource {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::aggregation_source::v1_2_1::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "AggregationType")]
        pub aggregation_type: Option<crate::aggregation_source::v1_2_1::AggregationType>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "HostName")]
        pub host_name: Option<String>,
        ...
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::aggregation_source::v1_2_1::Links>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,
        ...
        pub password: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SNMP")]
        pub snmp: Option<crate::aggregation_source::v1_2_1::SNMPSettings>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "UserName")]
        pub user_name: Option<String>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct SNMPSettings {
        ...
        pub authentication_protocol:
            Option<crate::aggregation_source::v1_2_1::SNMPAuthenticationProtocols>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "EncryptionKey")]
        pub encryption_key: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "EncryptionKeySet")]
        pub encryption_key_set: Option<bool>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "EncryptionProtocol")]
        pub encryption_protocol: Option<crate::aggregation_source::v1_2_1::SNMPEncryptionProtocols>,

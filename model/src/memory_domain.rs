pub type MemoryDomain = crate::memory_domain::v1_5_1::MemoryDomain;
pub mod v1_5_0 {
...
pub mod v1_5_1 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::memory_domain::v1_5_1::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Links {
        #[serde(skip_serializing_if = "Option::is_none", rename = "CXLLogicalDevices")]
    ...
    pub struct MemoryDomain {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::memory_domain::v1_5_1::Actions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "AllowsBlockProvisioning"
        )]
        ...
        pub allows_sparing: Option<bool>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::memory_domain::v1_5_1::MemoryDomainDescription>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub interleavable_memory_sets: Option<Vec<crate::memory_domain::v1_5_1::MemorySet>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::memory_domain::v1_5_1::Links>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "MemoryChunkIncrementMiB"
        )]
    ...
    #[serde(untagged)]
    pub enum MemoryDomainDescription {
        V000001(crate::memory_domain::v1_5_1::MemoryDomainDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for MemoryDomainDescription {
        fn default() -> Self {
            Self::V000001(Default::default())
        }
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum MemoryDomainDescriptionN1 {
        #[default]
        #[serde(rename = "null")]
        Null,
    }

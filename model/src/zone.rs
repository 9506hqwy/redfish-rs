...
#[serde(untagged)]
pub enum Zone {
    V010601(crate::zone::v1_6_1::Zone),
    V010501(crate::zone::v1_5_1::Zone),
    V010403(crate::zone::v1_4_3::Zone),
    V010304(crate::zone::v1_3_4::Zone),
    V010204(crate::zone::v1_2_4::Zone),
    V010105(crate::zone::v1_1_5::Zone),
    V010006(crate::zone::v1_0_6::Zone),
...
pub mod v1_0_6 {
    ...
    pub struct Zone {
        ...
        pub links: Option<crate::zone::v1_0_6::Links>,
        #[serde(rename = "Name")]
        pub name: String,
...
pub mod v1_1_5 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::zone::v1_1_5::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Links {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Endpoints")]
    ...
    pub struct Zone {
        ...
        pub actions: Option<crate::zone::v1_1_5::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::zone::v1_1_5::Links>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,
...
pub mod v1_2_4 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::zone::v1_2_4::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Links {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Endpoints")]
    ...
    pub struct Zone {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::zone::v1_2_4::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(rename = "Id")]
        pub id: String,
        ...
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::zone::v1_2_4::Links>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,
...
pub mod v1_3_4 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::zone::v1_3_4::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct Zone {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::zone::v1_3_4::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub external_accessibility: Option<crate::zone::v1_3_4::ExternalAccessibility>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Identifiers")]
        pub identifiers: Option<Vec<crate::resource::Identifier>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::zone::v1_3_4::Links>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,
...
pub mod v1_4_3 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::zone::v1_4_3::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum ExternalAccessibility {
        #[default]
    ...
    pub struct Zone {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::zone::v1_4_3::Actions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub external_accessibility: Option<crate::zone::v1_4_3::ExternalAccessibility>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Identifiers")]
        pub identifiers: Option<Vec<crate::resource::Identifier>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::zone::v1_4_3::Links>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,
        ...
        pub zone_type: Option<crate::zone::v1_4_3::ZoneType>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum ZoneType {
        #[default]
...
pub mod v1_5_1 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::zone::v1_5_1::OemActions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "#Zone.AddEndpoint")]
        pub zone_add_endpoint: Option<crate::zone::v1_5_1::AddEndpoint>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#Zone.RemoveEndpoint"
        )]
        pub zone_remove_endpoint: Option<crate::zone::v1_5_1::RemoveEndpoint>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct Zone {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::zone::v1_5_1::Actions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "DefaultRoutingEnabled"
        )]
        ...
        pub external_accessibility: Option<crate::zone::v1_5_1::ExternalAccessibility>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Identifiers")]
        pub identifiers: Option<Vec<crate::resource::Identifier>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::zone::v1_5_1::Links>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,
        ...
        pub status: Option<crate::resource::Status>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ZoneType")]
        pub zone_type: Option<crate::zone::v1_5_1::ZoneType>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum ZoneType {
        #[default]

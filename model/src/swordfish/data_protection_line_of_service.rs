...
#[serde(untagged)]
pub enum DataProtectionLineOfService {
    V010300(crate::swordfish::data_protection_line_of_service::v1_3_0::DataProtectionLineOfService),
    V010201(crate::swordfish::data_protection_line_of_service::v1_2_1::DataProtectionLineOfService),
    V010102(crate::swordfish::data_protection_line_of_service::v1_1_2::DataProtectionLineOfService),
    V010002(crate::swordfish::data_protection_line_of_service::v1_0_2::DataProtectionLineOfService),
    OdataV4IdRef(crate::odata_v4::IdRef),
}
impl Default for DataProtectionLineOfService {
    fn default() -> Self {
...
pub mod v1_0_2 {
    ...
    pub struct Actions {
        ...
        pub data_protection_line_of_service_create_replicas:
            Option<crate::swordfish::data_protection_line_of_service::v1_0_2::CreateReplicas>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
...
pub mod v1_1_2 {
    ...
    pub struct Actions {
        ...
        pub data_protection_line_of_service_create_replicas:
            Option<crate::swordfish::data_protection_line_of_service::v1_1_2::CreateReplicas>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct CreateReplicas {
        #[serde(skip_serializing_if = "Option::is_none", rename = "target")]
...
pub mod v1_2_1 {
    ...
    pub struct Actions {
        ...
        pub data_protection_line_of_service_create_replicas:
            Option<crate::swordfish::data_protection_line_of_service::v1_2_1::CreateReplicas>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::swordfish::data_protection_line_of_service::v1_2_1::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct CreateReplicas {
        #[serde(skip_serializing_if = "Option::is_none", rename = "target")]
    ...
    pub struct CreateReplicasRequestBody {
        ...
        pub replica_requests:
            Option<Vec<crate::swordfish::data_protection_line_of_service::v1_2_1::ReplicaRequest>>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct DataProtectionLineOfService {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::swordfish::data_protection_line_of_service::v1_2_1::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(rename = "Id")]
        pub id: String,

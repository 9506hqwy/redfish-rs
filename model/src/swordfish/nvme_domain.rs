...
#[serde(untagged)]
pub enum NVMeDomain {
    V010100(crate::swordfish::nvme_domain::v1_1_0::NVMeDomain),
    V010000(crate::swordfish::nvme_domain::v1_0_0::NVMeDomain),
    OdataV4IdRef(crate::odata_v4::IdRef),
}
impl Default for NVMeDomain {
    fn default() -> Self {
...
pub mod v1_0_0 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::swordfish::nvme_domain::v1_0_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Links {
    ...
    pub struct NVMeDomain {
        ...
        pub actions: Option<crate::swordfish::nvme_domain::v1_0_0::Actions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub links: Option<crate::swordfish::nvme_domain::v1_0_0::Links>,
        #[serde(
            skip_serializing_if = "Option::is_none",

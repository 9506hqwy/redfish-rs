...
pub mod v1_0_3 {
    ...
    pub struct FileSystem {
        ...
        pub character_code_set:
            Option<Vec<crate::swordfish::file_system::v1_0_3::CharacterCodeSet>>,
        ...
        pub links: Option<crate::swordfish::file_system::v1_0_3::Links>,
        #[serde(
            skip_serializing_if = "Option::is_none",
...
pub mod v1_1_4 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::swordfish::file_system::v1_1_4::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum CharacterCodeSet {
        #[default]
    ...
    pub struct FileSystem {
        ...
        pub actions: Option<crate::swordfish::file_system::v1_1_4::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "BlockSizeBytes")]
        pub block_size_bytes: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Capacity")]
        pub capacity: Option<crate::swordfish::capacity::v1_0_0::Capacity>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", rename = "CharacterCodeSet")]
        pub character_code_set:
            Option<Vec<crate::swordfish::file_system::v1_1_4::CharacterCodeSet>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ClusterSizeBytes")]
        pub cluster_size_bytes: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        ...
        pub imported_shares: Option<Vec<crate::swordfish::file_system::ImportedShare>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::swordfish::file_system::v1_1_4::Links>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "LowSpaceWarningThresholdPercents"
        )]
...
pub mod v1_2_2 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::swordfish::file_system::v1_2_2::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum CharacterCodeSet {
        #[default]
    ...
    pub struct FileSystem {
        ...
        pub access_capabilities:
            Option<Vec<crate::swordfish::data_storage_los_capabilities::StorageAccessCapability>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::swordfish::file_system::v1_2_2::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "BlockSizeBytes")]
        pub block_size_bytes: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Capacity")]
        pub capacity: Option<crate::swordfish::capacity::v1_0_0::Capacity>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", rename = "CharacterCodeSet")]
        pub character_code_set:
            Option<Vec<crate::swordfish::file_system::v1_2_2::CharacterCodeSet>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ClusterSizeBytes")]
        pub cluster_size_bytes: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::swordfish::file_system::v1_2_2::Links>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "LowSpaceWarningThresholdPercents"
        )]

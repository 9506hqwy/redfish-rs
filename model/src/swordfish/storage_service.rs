pub type StorageService = crate::swordfish::storage_service::v1_7_0::StorageService;
pub mod v1_7_0 {
    use serde::{Deserialize, Serialize};
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::swordfish::storage_service::v1_7_0::OemActions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#StorageService.SetEncryptionKey"
        )]
        pub storage_service_set_encryption_key:
            Option<crate::swordfish::storage_service::v1_7_0::SetEncryptionKey>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Links {
        #[serde(
    ...
    pub struct StorageService {
        ...
        pub actions: Option<crate::swordfish::storage_service::v1_7_0::Actions>,
        ...
        pub description:
            Option<crate::swordfish::storage_service::v1_7_0::StorageServiceDescription>,
        ...
        pub links: Option<crate::swordfish::storage_service::v1_7_0::Links>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Metrics")]
        pub metrics: Option<crate::swordfish::storage_service::v1_7_0::StorageServiceMetrics>,
        #[serde(rename = "Name")]
        pub name: String,
    ...
    #[serde(untagged)]
    pub enum StorageServiceDescription {
        V000001(crate::swordfish::storage_service::v1_7_0::StorageServiceDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for StorageServiceDescription {
        fn default() -> Self {
            Self::V000001(Default::default())
        }
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum StorageServiceDescriptionN1 {
        #[default]
        #[serde(rename = "null")]
        Null,
    }
    #[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
    #[serde(untagged)]
    pub enum StorageServiceMetrics {
        V000001(crate::swordfish::storage_service::v1_7_0::StorageServiceMetricsN1),
        OdataV4IdRef(crate::odata_v4::IdRef),
    }
    impl Default for StorageServiceMetrics {
        fn default() -> Self {
            Self::V000001(Default::default())
        }
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum StorageServiceMetricsN1 {
        #[default]
        #[serde(rename = "null")]
        Null,
    }

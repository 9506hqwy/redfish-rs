...
pub type ConsistencyGroup = crate::swordfish::consistency_group::v1_1_1::ConsistencyGroup;
#[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
...
pub mod v1_1_1 {
    ...
    pub struct ConsistencyGroup {
        ...
        pub consistency_method:
            Option<crate::swordfish::consistency_group::v1_1_1::ConsistencyGroupConsistencyMethod>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ConsistencyType")]
        pub consistency_type:
            Option<crate::swordfish::consistency_group::v1_1_1::ConsistencyGroupConsistencyType>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description:
            Option<crate::swordfish::consistency_group::v1_1_1::ConsistencyGroupDescription>,
        #[serde(rename = "Id")]
        pub id: String,
    ...
    #[serde(untagged)]
    pub enum ConsistencyGroupConsistencyMethod {
        V000001(crate::swordfish::consistency_group::v1_1_1::ConsistencyGroupConsistencyMethodN1),
        ConsistencyGroupApplicationConsistencyMethod(
            crate::swordfish::consistency_group::ApplicationConsistencyMethod,
        ),
    }
    impl Default for ConsistencyGroupConsistencyMethod {
        fn default() -> Self {
            Self::V000001(Default::default())
        }
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum ConsistencyGroupConsistencyMethodN1 {
        #[default]
        #[serde(rename = "null")]
        Null,
    }
    #[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
    #[serde(untagged)]
    pub enum ConsistencyGroupConsistencyType {
        V000001(crate::swordfish::consistency_group::v1_1_1::ConsistencyGroupConsistencyTypeN1),
        ConsistencyGroupConsistencyType(crate::swordfish::consistency_group::ConsistencyType),
    }
    impl Default for ConsistencyGroupConsistencyType {
        fn default() -> Self {
            Self::V000001(Default::default())
        }
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum ConsistencyGroupConsistencyTypeN1 {
        #[default]
        #[serde(rename = "null")]
        Null,
    }
    #[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
    #[serde(untagged)]
    pub enum ConsistencyGroupDescription {
        V000001(crate::swordfish::consistency_group::v1_1_1::ConsistencyGroupDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for ConsistencyGroupDescription {
        fn default() -> Self {
            Self::V000001(Default::default())
        }
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum ConsistencyGroupDescriptionN1 {
        #[default]
        #[serde(rename = "null")]
        Null,
    }

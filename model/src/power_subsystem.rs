...
#[serde(untagged)]
pub enum PowerSubsystem {
    V010100(crate::power_subsystem::v1_1_0::PowerSubsystem),
    V010000(crate::power_subsystem::v1_0_0::PowerSubsystem),
...
pub mod v1_0_0 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::power_subsystem::v1_0_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct PowerSubsystem {
        ...
        pub actions: Option<crate::power_subsystem::v1_0_0::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Allocation")]
        pub allocation: Option<crate::power_subsystem::v1_0_0::PowerAllocation>,

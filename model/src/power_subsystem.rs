pub type PowerSubsystem = crate::power_subsystem::v1_1_3::PowerSubsystem;
pub mod v1_1_2 {
...
pub mod v1_1_3 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::power_subsystem::v1_1_3::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct OemActions {}
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct PowerSubsystem {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::power_subsystem::v1_1_3::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Allocation")]
        pub allocation: Option<crate::power_subsystem::v1_1_3::PowerAllocation>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Batteries")]
        pub batteries: Option<crate::odata_v4::IdRef>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "CapacityWatts")]
        pub capacity_watts: Option<f64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::power_subsystem::v1_1_3::PowerSubsystemDescription>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(rename = "Name")]
        pub name: String,
    ...
    #[serde(untagged)]
    pub enum PowerSubsystemDescription {
        V000001(crate::power_subsystem::v1_1_3::PowerSubsystemDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for PowerSubsystemDescription {
        fn default() -> Self {

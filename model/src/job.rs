...
#[serde(untagged)]
pub enum Job {
    V010201(crate::job::v1_2_1::Job),
    V010103(crate::job::v1_1_3::Job),
    V010009(crate::job::v1_0_9::Job),
...
pub mod v1_0_9 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::job::v1_0_9::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Job {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::job::v1_0_9::Actions>,
        ...
        pub job_state: Option<crate::job::v1_0_9::JobState>,
        ...
        pub payload: Option<crate::job::v1_0_9::Payload>,
...
pub mod v1_1_3 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::job::v1_1_3::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Job {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::job::v1_1_3::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "CreatedBy")]
        pub created_by: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        ...
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "JobState")]
        pub job_state: Option<crate::job::v1_1_3::JobState>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "JobStatus")]
        pub job_status: Option<crate::resource::Health>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MaxExecutionTime")]
        pub max_execution_time: Option<String>,
        ...
        pub oem: Option<crate::resource::Oem>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Payload")]
        pub payload: Option<crate::job::v1_1_3::Payload>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "PercentComplete")]
        pub percent_complete: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Schedule")]
        pub schedule: Option<crate::schedule::Schedule>,

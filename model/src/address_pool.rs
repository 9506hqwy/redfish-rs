pub type AddressPool = crate::address_pool::v1_3_0::AddressPool;
pub mod v1_3_0 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::address_pool::v1_3_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct AddressPool {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::address_pool::v1_3_0::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::address_pool::v1_3_0::AddressPoolDescription>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Ethernet")]
        pub ethernet: Option<crate::address_pool::v1_3_0::Ethernet>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "GenZ")]
        pub gen_z: Option<crate::address_pool::v1_3_0::GenZ>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::address_pool::v1_3_0::Links>,
        #[serde(rename = "Name")]
        pub name: String,
    ...
    #[serde(untagged)]
    pub enum AddressPoolDescription {
        V000001(crate::address_pool::v1_3_0::AddressPoolDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for AddressPoolDescription {
        fn default() -> Self {
            Self::V000001(Default::default())
        }
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum AddressPoolDescriptionN1 {
        #[default]
        #[serde(rename = "null")]
        Null,
    }
    ...
    pub struct BGPEvpn {
        ...
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "ARPSuppressionEnabled"
        )]
        pub arp_suppression_enabled: Option<bool>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub esi_number_range: Option<crate::address_pool::v1_3_0::ESINumberRange>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "EVINumberRange")]
        pub evi_number_range: Option<crate::address_pool::v1_3_0::EVINumberRange>,
        ...
        pub gateway_ip_address_range: Option<crate::address_pool::v1_3_0::GatewayIPAddressRange>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "NDPProxyEnabled")]
        pub ndp_proxy_enabled: Option<bool>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "NDPSuppressionEnabled"
        )]
        pub ndp_suppression_enabled: Option<bool>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub route_distinguisher_range: Option<crate::address_pool::v1_3_0::RouteDistinguisherRange>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub route_target_range: Option<crate::address_pool::v1_3_0::RouteTargetRange>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub vlan_identifier_address_range:
            Option<crate::address_pool::v1_3_0::VLANIdentifierAddressRange>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct BGPNeighbor {
        ...
        pub max_prefix: Option<crate::address_pool::v1_3_0::MaxPrefix>,
        #[serde(
            skip_serializing_if = "Option::is_none",
    ...
    pub struct CommonBGPProperties {
        ...
        pub as_number_range: Option<crate::address_pool::v1_3_0::ASNumberRange>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "BGPNeighbor")]
        pub bgp_neighbor: Option<crate::address_pool::v1_3_0::BGPNeighbor>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "BGPRoute")]
        pub bgp_route: Option<crate::address_pool::v1_3_0::BGPRoute>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "GracefulRestart")]
        pub graceful_restart: Option<crate::address_pool::v1_3_0::GracefulRestart>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MultiplePaths")]
        pub multiple_paths: Option<crate::address_pool::v1_3_0::MultiplePaths>,
        #[serde(
            skip_serializing_if = "Option::is_none",
    ...
    pub struct Ethernet {
        ...
        pub bfd_single_hop_only: Option<crate::address_pool::v1_3_0::BFDSingleHopOnly>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "BGPEvpn")]
        pub bgp_evpn: Option<crate::address_pool::v1_3_0::BGPEvpn>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "EBGP")]
        pub ebgp: Option<crate::address_pool::v1_3_0::EBGP>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "IPv4")]
        pub ipv4: Option<crate::address_pool::v1_3_0::IPv4>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MultiProtocolEBGP")]
        pub multi_protocol_ebgp: Option<crate::address_pool::v1_3_0::EBGP>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MultiProtocolIBGP")]
        pub multi_protocol_ibgp: Option<crate::address_pool::v1_3_0::CommonBGPProperties>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct IPv4 {
        ...
        pub dhcp: Option<crate::address_pool::v1_3_0::DHCP>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub ebgp_address_range: Option<crate::address_pool::v1_3_0::IPv4AddressRange>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "FabricLinkAddressRange"
        )]
        pub fabric_link_address_range: Option<crate::address_pool::v1_3_0::IPv4AddressRange>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "GatewayIPAddress")]
        pub gateway_ip_address: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "HostAddressRange")]
        pub host_address_range: Option<crate::address_pool::v1_3_0::IPv4AddressRange>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "IBGPAddressRange")]
        pub ibgp_address_range: Option<crate::address_pool::v1_3_0::IPv4AddressRange>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "LoopbackAddressRange"
        )]
        pub loopback_address_range: Option<crate::address_pool::v1_3_0::IPv4AddressRange>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "ManagementAddressRange"
        )]
        pub management_address_range: Option<crate::address_pool::v1_3_0::IPv4AddressRange>,
        ...
        pub system_mac_range: Option<crate::address_pool::v1_3_0::SystemMACRange>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "VLANIdentifierAddressRange"
        )]

...
#[serde(untagged)]
pub enum PowerSupplyMetrics {
    V010100(crate::power_supply_metrics::v1_1_0::PowerSupplyMetrics),
    V010001(crate::power_supply_metrics::v1_0_1::PowerSupplyMetrics),
...
pub mod v1_0_1 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::power_supply_metrics::v1_0_1::OemActions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#PowerSupplyMetrics.ResetMetrics"
        )]
        pub power_supply_metrics_reset_metrics:
            Option<crate::power_supply_metrics::v1_0_1::ResetMetrics>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct PowerSupplyMetrics {
        ...
        pub actions: Option<crate::power_supply_metrics::v1_0_1::Actions>,

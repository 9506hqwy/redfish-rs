...
#[serde(untagged)]
pub enum LogService {
    V010400(crate::log_service::v1_4_0::LogService),
    V010301(crate::log_service::v1_3_1::LogService),
    V010202(crate::log_service::v1_2_2::LogService),
    V010104(crate::log_service::v1_1_4::LogService),
    V010009(crate::log_service::v1_0_9::LogService),
...
pub mod v1_0_9 {
    ...
    pub struct Actions {
        ...
        pub log_service_clear_log: Option<crate::log_service::v1_0_9::ClearLog>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::log_service::v1_0_9::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct ClearLog {
    ...
    pub struct LogService {
        ...
        pub actions: Option<crate::log_service::v1_0_9::Actions>,
        ...
        pub over_write_policy: Option<crate::log_service::v1_0_9::OverWritePolicy>,
...
pub mod v1_1_4 {
    ...
    pub struct Actions {
        ...
        pub log_service_clear_log: Option<crate::log_service::v1_1_4::ClearLog>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::log_service::v1_1_4::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct ClearLog {
        #[serde(skip_serializing_if = "Option::is_none", rename = "target")]
    ...
    pub struct LogService {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::log_service::v1_1_4::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "DateTime")]
        pub date_time: Option<String>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub log_entry_type: Option<crate::log_service::v1_1_4::LogEntryTypes>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MaxNumberOfRecords")]
        pub max_number_of_records: Option<i64>,
        #[serde(rename = "Name")]
        pub name: String,
        ...
        pub oem: Option<crate::resource::Oem>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "OverWritePolicy")]
        pub over_write_policy: Option<crate::log_service::v1_1_4::OverWritePolicy>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ServiceEnabled")]
        pub service_enabled: Option<bool>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Status")]
        pub status: Option<crate::resource::Status>,
...
pub mod v1_2_2 {
    ...
    pub struct Actions {
        ...
        pub log_service_clear_log: Option<crate::log_service::v1_2_2::ClearLog>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#LogService.CollectDiagnosticData"
        )]
        pub log_service_collect_diagnostic_data:
            Option<crate::log_service::v1_2_2::CollectDiagnosticData>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::log_service::v1_2_2::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct ClearLog {
        #[serde(skip_serializing_if = "Option::is_none", rename = "target")]
    ...
    pub struct CollectDiagnosticDataRequestBody {
        ...
        pub diagnostic_data_type: crate::log_service::v1_2_2::LogDiagnosticDataTypes,
        #[serde(
            skip_serializing_if = "Option::is_none",
    ...
    pub struct LogService {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::log_service::v1_2_2::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "DateTime")]
        pub date_time: Option<String>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LogEntryType")]
        pub log_entry_type: Option<crate::log_service::v1_2_2::LogEntryTypes>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MaxNumberOfRecords")]
        pub max_number_of_records: Option<i64>,
        #[serde(rename = "Name")]
        pub name: String,
        ...
        pub oem: Option<crate::resource::Oem>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "OverWritePolicy")]
        pub over_write_policy: Option<crate::log_service::v1_2_2::OverWritePolicy>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ServiceEnabled")]
        pub service_enabled: Option<bool>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Status")]
        pub status: Option<crate::resource::Status>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SyslogFilters")]
        pub syslog_filters: Option<Vec<crate::log_service::v1_2_2::SyslogFilter>>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct OemActions {}
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct SyslogFilter {
        ...
        pub log_facilities: Option<Vec<crate::log_service::v1_2_2::SyslogFacility>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LowestSeverity")]
        pub lowest_severity: Option<crate::log_service::v1_2_2::SyslogSeverity>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
...
pub mod v1_3_1 {
    ...
    pub struct Actions {
        ...
        pub log_service_clear_log: Option<crate::log_service::v1_3_1::ClearLog>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#LogService.CollectDiagnosticData"
        )]
        pub log_service_collect_diagnostic_data:
            Option<crate::log_service::v1_3_1::CollectDiagnosticData>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::log_service::v1_3_1::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct ClearLog {
        #[serde(skip_serializing_if = "Option::is_none", rename = "target")]
    ...
    pub struct CollectDiagnosticDataRequestBody {
        #[serde(rename = "DiagnosticDataType")]
        pub diagnostic_data_type: crate::log_service::v1_3_1::LogDiagnosticDataTypes,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "OEMDiagnosticDataType"
        )]
    ...
    pub struct LogService {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::log_service::v1_3_1::Actions>,
        ...
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LogEntryType")]
        pub log_entry_type: Option<crate::log_service::v1_3_1::LogEntryTypes>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MaxNumberOfRecords")]
        pub max_number_of_records: Option<i64>,
        #[serde(rename = "Name")]
        pub name: String,
        ...
        pub oem: Option<crate::resource::Oem>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "OverWritePolicy")]
        pub over_write_policy: Option<crate::log_service::v1_3_1::OverWritePolicy>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ServiceEnabled")]
        pub service_enabled: Option<bool>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Status")]
        pub status: Option<crate::resource::Status>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SyslogFilters")]
        pub syslog_filters: Option<Vec<crate::log_service::v1_3_1::SyslogFilter>>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct OemActions {}
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct SyslogFilter {
        #[serde(skip_serializing_if = "Option::is_none", rename = "LogFacilities")]
        pub log_facilities: Option<Vec<crate::log_service::v1_3_1::SyslogFacility>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LowestSeverity")]
        pub lowest_severity: Option<crate::log_service::v1_3_1::SyslogSeverity>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum SyslogSeverity {
        #[default]

...
pub type AccountService = crate::account_service::v1_17_0::AccountService;
pub type MFABypass = crate::account_service::v1_17_0::MFABypass;
...
pub mod v1_17_0 {
    ...
    pub struct AccountService {
        ...
        pub accounts: Option<crate::odata_v4::IdRef>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::account_service::v1_17_0::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ActiveDirectory")]
        pub active_directory: Option<crate::account_service::v1_17_0::ExternalAccountProvider>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "AdditionalExternalAccountProviders"
        )]
        ...
        pub auth_failure_logging_threshold: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::account_service::v1_17_0::AccountServiceDescription>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        #[serde(skip_serializing_if = "Option::is_none", rename = "HTTPBasicAuth")]
        pub http_basic_auth: Option<crate::account_service::v1_17_0::AccountServiceHTTPBasicAuth>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LDAP")]
        pub ldap: Option<crate::account_service::v1_17_0::ExternalAccountProvider>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LocalAccountAuth")]
        pub local_account_auth: Option<crate::account_service::v1_17_0::LocalAccountAuth>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MaxPasswordLength")]
        pub max_password_length: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MinPasswordLength")]
        pub min_password_length: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MultiFactorAuth")]
        pub multi_factor_auth:
            Option<crate::account_service::v1_17_0::AccountServiceMultiFactorAuth>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "OAuth2")]
        pub oauth2: Option<crate::account_service::v1_17_0::AccountServiceOAuth2>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.etag")]
        pub odata_etag: Option<String>,
        ...
        pub outbound_connections:
            Option<crate::account_service::v1_17_0::AccountServiceOutboundConnections>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "PasswordExpirationDays"
        )]
        ...
        pub supported_oem_account_types: Option<Vec<String>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "TACACSplus")]
        pub tacac_splus: Option<crate::account_service::v1_17_0::AccountServiceTACACSplus>,
    }
    #[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
    #[serde(untagged)]
    pub enum AccountServiceDescription {
        V000001(crate::account_service::v1_17_0::AccountServiceDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for AccountServiceDescription {
        fn default() -> Self {
    ...
    #[serde(untagged)]
    pub enum AccountServiceHTTPBasicAuth {
        V011700(crate::account_service::v1_17_0::BasicAuthState),
        V000001(crate::account_service::v1_17_0::AccountServiceHTTPBasicAuthN1),
    }
    impl Default for AccountServiceHTTPBasicAuth {
        fn default() -> Self {
    ...
    #[serde(untagged)]
    pub enum AccountServiceMultiFactorAuth {
        V011700(crate::account_service::v1_17_0::MultiFactorAuth),
        V000001(crate::account_service::v1_17_0::AccountServiceMultiFactorAuthN1),
    }
    impl Default for AccountServiceMultiFactorAuth {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum AccountServiceOAuth2 {
        V011700(crate::account_service::v1_17_0::ExternalAccountProvider),
        V000001(crate::account_service::v1_17_0::AccountServiceOAuth2N1),
    }
    impl Default for AccountServiceOAuth2 {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum AccountServiceOutboundConnections {
        V000001(crate::account_service::v1_17_0::AccountServiceOutboundConnectionsN1),
        OdataV4IdRef(crate::odata_v4::IdRef),
    }
    impl Default for AccountServiceOutboundConnections {
        fn default() -> Self {
    ...
    pub enum AccountServiceTACACSplus {
        V011700(crate::account_service::v1_17_0::ExternalAccountProvider),
        V000001(crate::account_service::v1_17_0::AccountServiceTACACSplusN1),
    }
    impl Default for AccountServiceTACACSplus {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::account_service::v1_17_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Authentication {
        #[serde(skip_serializing_if = "Option::is_none", rename = "AuthenticationType")]
        pub authentication_type:
            Option<crate::account_service::v1_17_0::AuthenticationAuthenticationType>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "EncryptionKey")]
        pub encryption_key: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "EncryptionKeySet")]
        pub encryption_key_set: Option<bool>,
    ...
    #[serde(untagged)]
    pub enum AuthenticationAuthenticationType {
        V011700(crate::account_service::v1_17_0::AuthenticationTypes),
        V000001(crate::account_service::v1_17_0::AuthenticationAuthenticationTypeN1),
    }
    impl Default for AuthenticationAuthenticationType {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub struct ClientCertificate {
        ...
        pub certificate_mapping_attribute:
            Option<crate::account_service::v1_17_0::ClientCertificateCertificateMappingAttribute>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Certificates")]
        pub certificates: Option<crate::odata_v4::IdRef>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Enabled")]
        pub enabled: Option<bool>,
    ...
    #[serde(untagged)]
    pub enum ClientCertificateCertificateMappingAttribute {
        V011700(crate::account_service::v1_17_0::CertificateMappingAttribute),
        V000001(crate::account_service::v1_17_0::ClientCertificateCertificateMappingAttributeN1),
    }
    impl Default for ClientCertificateCertificateMappingAttribute {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub struct ExternalAccountProvider {
        ...
        pub account_provider_type:
            Option<crate::account_service::v1_17_0::ExternalAccountProviderAccountProviderType>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Authentication")]
        pub authentication: Option<crate::account_service::v1_17_0::Authentication>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Certificates")]
        pub certificates: Option<crate::odata_v4::IdRef>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LDAPService")]
        pub ldap_service: Option<crate::account_service::v1_17_0::LDAPService>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "OAuth2Service")]
        pub oauth2_service:
            Option<crate::account_service::v1_17_0::ExternalAccountProviderOAuth2Service>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "PasswordSet")]
        pub password_set: Option<bool>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Priority")]
        pub priority: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "RemoteRoleMapping")]
        pub remote_role_mapping:
            Option<Vec<crate::account_service::v1_17_0::ExternalAccountProviderRemoteRoleMapping>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Retries")]
        pub retries: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ServiceAddresses")]
        pub service_addresses: Option<Vec<String>>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", rename = "TACACSplusService")]
        pub tacac_splus_service:
            Option<crate::account_service::v1_17_0::ExternalAccountProviderTACACSplusService>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "TimeoutSeconds")]
        pub timeout_seconds: Option<i64>,
    }
    #[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
    #[serde(untagged)]
    pub enum ExternalAccountProviderAccountProviderType {
        V011700(crate::account_service::v1_17_0::AccountProviderTypes),
        V000001(crate::account_service::v1_17_0::ExternalAccountProviderAccountProviderTypeN1),
    }
    impl Default for ExternalAccountProviderAccountProviderType {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum ExternalAccountProviderOAuth2Service {
        V011700(crate::account_service::v1_17_0::OAuth2Service),
        V000001(crate::account_service::v1_17_0::ExternalAccountProviderOAuth2ServiceN1),
    }
    impl Default for ExternalAccountProviderOAuth2Service {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum ExternalAccountProviderRemoteRoleMapping {
        V011700(crate::account_service::v1_17_0::RoleMapping),
        V000001(crate::account_service::v1_17_0::ExternalAccountProviderRemoteRoleMappingN1),
    }
    impl Default for ExternalAccountProviderRemoteRoleMapping {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum ExternalAccountProviderTACACSplusService {
        V011700(crate::account_service::v1_17_0::TACACSplusService),
        V000001(crate::account_service::v1_17_0::ExternalAccountProviderTACACSplusServiceN1),
    }
    impl Default for ExternalAccountProviderTACACSplusService {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub struct LDAPService {
        ...
        pub oem: Option<crate::resource::Oem>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SearchSettings")]
        pub search_settings: Option<crate::account_service::v1_17_0::LDAPSearchSettings>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum LocalAccountAuth {
        #[default]
    ...
    pub struct MFABypass {
        #[serde(skip_serializing_if = "Option::is_none", rename = "BypassTypes")]
        pub bypass_types: Option<Vec<crate::account_service::v1_17_0::MFABypassBypassTypes>>,
    }
    #[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
    #[serde(untagged)]
    pub enum MFABypassBypassTypes {
        V000001(crate::account_service::v1_17_0::MFABypassBypassTypesN1),
        AccountServiceMFABypassType(crate::account_service::MFABypassType),
    }
    impl Default for MFABypassBypassTypes {
        fn default() -> Self {
    ...
    pub struct MultiFactorAuth {
        #[serde(skip_serializing_if = "Option::is_none", rename = "ClientCertificate")]
        pub client_certificate:
            Option<crate::account_service::v1_17_0::MultiFactorAuthClientCertificate>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "GoogleAuthenticator"
        )]
        pub google_authenticator:
            Option<crate::account_service::v1_17_0::MultiFactorAuthGoogleAuthenticator>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "MicrosoftAuthenticator"
        )]
        pub microsoft_authenticator:
            Option<crate::account_service::v1_17_0::MultiFactorAuthMicrosoftAuthenticator>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "OneTimePasscode")]
        pub one_time_passcode:
            Option<crate::account_service::v1_17_0::MultiFactorAuthOneTimePasscode>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SecurID")]
        pub secur_id: Option<crate::account_service::v1_17_0::MultiFactorAuthSecurID>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "TimeBasedOneTimePassword"
        )]
        pub time_based_one_time_password:
            Option<crate::account_service::v1_17_0::MultiFactorAuthTimeBasedOneTimePassword>,
    }
    #[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
    #[serde(untagged)]
    pub enum MultiFactorAuthClientCertificate {
        V011700(crate::account_service::v1_17_0::ClientCertificate),
        V000001(crate::account_service::v1_17_0::MultiFactorAuthClientCertificateN1),
    }
    impl Default for MultiFactorAuthClientCertificate {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum MultiFactorAuthGoogleAuthenticator {
        V011700(crate::account_service::v1_17_0::GoogleAuthenticator),
        V000001(crate::account_service::v1_17_0::MultiFactorAuthGoogleAuthenticatorN1),
    }
    impl Default for MultiFactorAuthGoogleAuthenticator {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum MultiFactorAuthMicrosoftAuthenticator {
        V011700(crate::account_service::v1_17_0::MicrosoftAuthenticator),
        V000001(crate::account_service::v1_17_0::MultiFactorAuthMicrosoftAuthenticatorN1),
    }
    impl Default for MultiFactorAuthMicrosoftAuthenticator {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum MultiFactorAuthOneTimePasscode {
        V011700(crate::account_service::v1_17_0::OneTimePasscode),
        V000001(crate::account_service::v1_17_0::MultiFactorAuthOneTimePasscodeN1),
    }
    impl Default for MultiFactorAuthOneTimePasscode {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum MultiFactorAuthSecurID {
        V011700(crate::account_service::v1_17_0::SecurID),
        V000001(crate::account_service::v1_17_0::MultiFactorAuthSecurIDN1),
    }
    impl Default for MultiFactorAuthSecurID {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub enum MultiFactorAuthTimeBasedOneTimePassword {
        V011700(crate::account_service::v1_17_0::TimeBasedOneTimePassword),
        V000001(crate::account_service::v1_17_0::MultiFactorAuthTimeBasedOneTimePasswordN1),
    }
    ...
    pub struct OAuth2Service {
        ...
        pub issuer: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Mode")]
        pub mode: Option<crate::account_service::v1_17_0::OAuth2Mode>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "OAuthServiceSigningKeys"
        )]
    ...
    pub struct RoleMapping {
        ...
        pub local_account_types:
            Option<Vec<crate::account_service::v1_17_0::RoleMappingLocalAccountTypes>>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub local_role: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MFABypass")]
        pub mfa_bypass: Option<crate::account_service::v1_17_0::RoleMappingMFABypass>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::resource::Oem>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "RemoteGroup")]
        pub remote_group: Option<String>,
    ...
    pub enum RoleMappingLocalAccountTypes {
        V000001(crate::account_service::v1_17_0::RoleMappingLocalAccountTypesN1),
    ...
    #[serde(untagged)]
    pub enum RoleMappingMFABypass {
        V000001(crate::account_service::v1_17_0::RoleMappingMFABypassN1),
        AccountServiceMFABypass(crate::account_service::v1_17_0::MFABypass),
    }
    impl Default for RoleMappingMFABypass {
        fn default() -> Self {
    ...
    pub struct TACACSplusService {
        ...
        pub password_exchange_protocols: Option<
            Vec<crate::account_service::v1_17_0::TACACSplusServicePasswordExchangeProtocols>,
        >,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "PrivilegeLevelArgument"
    ...
    #[serde(untagged)]
    pub enum TACACSplusServicePasswordExchangeProtocols {
        V011700(crate::account_service::v1_17_0::TACACSplusPasswordExchangeProtocol),
        V000001(crate::account_service::v1_17_0::TACACSplusServicePasswordExchangeProtocolsN1),
    }
    impl Default for TACACSplusServicePasswordExchangeProtocols {
        fn default() -> Self {
            Self::V011700(Default::default())

pub type MetricDefinition = crate::metric_definition::v1_3_5::MetricDefinition;
pub mod v1_3_5 {
    use serde::{Deserialize, Serialize};
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::metric_definition::v1_3_5::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum Calculable {
        #[default]
    ...
    pub struct MetricDefinition {
        ...
        pub actions: Option<crate::metric_definition::v1_3_5::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Calculable")]
        pub calculable: Option<crate::metric_definition::v1_3_5::MetricDefinitionCalculable>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "CalculationAlgorithm"
        )]
        pub calculation_algorithm:
            Option<crate::metric_definition::v1_3_5::MetricDefinitionCalculationAlgorithm>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "CalculationParameters"
        )]
        pub calculation_parameters:
            Option<Vec<crate::metric_definition::v1_3_5::MetricDefinitionCalculationParameters>>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub description: Option<crate::metric_definition::v1_3_5::MetricDefinitionDescription>,
        ...
        pub implementation:
            Option<crate::metric_definition::v1_3_5::MetricDefinitionImplementation>,
        ...
        pub metric_data_type:
            Option<crate::metric_definition::v1_3_5::MetricDefinitionMetricDataType>,
        ...
        pub metric_type: Option<crate::metric_definition::v1_3_5::MetricDefinitionMetricType>,
        ...
        pub physical_context:
            Option<crate::metric_definition::v1_3_5::MetricDefinitionPhysicalContext>,
        ...
        pub wildcards: Option<Vec<crate::metric_definition::v1_3_5::Wildcard>>,
    }
    #[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
    #[serde(untagged)]
    pub enum MetricDefinitionCalculable {
        V010305(crate::metric_definition::v1_3_5::Calculable),
        V000001(crate::metric_definition::v1_3_5::MetricDefinitionCalculableN1),
    }
    impl Default for MetricDefinitionCalculable {
        fn default() -> Self {
            Self::V010305(Default::default())
        }
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub enum MetricDefinitionCalculationAlgorithm {
        V010305(crate::metric_definition::v1_3_5::CalculationAlgorithmEnum),
        V000001(crate::metric_definition::v1_3_5::MetricDefinitionCalculationAlgorithmN1),
    }
    ...
    pub enum MetricDefinitionCalculationParameters {
        V010305(crate::metric_definition::v1_3_5::CalculationParamsType),
        V000001(crate::metric_definition::v1_3_5::MetricDefinitionCalculationParametersN1),
    }
    ...
    pub enum MetricDefinitionDescription {
        V000001(crate::metric_definition::v1_3_5::MetricDefinitionDescriptionN1),
    ...
    pub enum MetricDefinitionImplementation {
        V010305(crate::metric_definition::v1_3_5::ImplementationType),
        V000001(crate::metric_definition::v1_3_5::MetricDefinitionImplementationN1),
    }
    ...
    pub enum MetricDefinitionMetricDataType {
        V010305(crate::metric_definition::v1_3_5::MetricDataType),
        V000001(crate::metric_definition::v1_3_5::MetricDefinitionMetricDataTypeN1),
    }
    ...
    pub enum MetricDefinitionMetricType {
        V010305(crate::metric_definition::v1_3_5::MetricType),
        V000001(crate::metric_definition::v1_3_5::MetricDefinitionMetricTypeN1),
    }
    ...
    pub enum MetricDefinitionPhysicalContext {
        V000001(crate::metric_definition::v1_3_5::MetricDefinitionPhysicalContextN1),

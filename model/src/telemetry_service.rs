...
pub enum TelemetryService {
    V010302(crate::telemetry_service::v1_3_2::TelemetryService),
    V010204(crate::telemetry_service::v1_2_4::TelemetryService),
    V010106(crate::telemetry_service::v1_1_6::TelemetryService),
    V010006(crate::telemetry_service::v1_0_6::TelemetryService),
...
pub mod v1_0_6 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::telemetry_service::v1_0_6::OemActions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#TelemetryService.SubmitTestMetricReport"
        )]
        pub telemetry_service_submit_test_metric_report:
            Option<crate::telemetry_service::v1_0_6::SubmitTestMetricReport>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct TelemetryService {
        ...
        pub actions: Option<crate::telemetry_service::v1_0_6::Actions>,
        ...
        pub supported_collection_functions:
            Option<Vec<crate::telemetry_service::v1_0_6::CollectionFunction>>,
...
pub mod v1_1_6 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::telemetry_service::v1_1_6::OemActions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#TelemetryService.SubmitTestMetricReport"
        )]
        pub telemetry_service_submit_test_metric_report:
            Option<crate::telemetry_service::v1_1_6::SubmitTestMetricReport>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum CollectionFunction {
        #[default]
    ...
    pub struct SubmitTestMetricReportRequestBody {
        ...
        pub generated_metric_report_values: Vec<crate::telemetry_service::v1_1_6::MetricValue>,
        #[serde(rename = "MetricReportName")]
        pub metric_report_name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MetricReportValues")]
        pub metric_report_values: Option<String>,
    ...
    pub struct TelemetryService {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::telemetry_service::v1_1_6::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(rename = "Id")]
        pub id: String,
        ...
        pub supported_collection_functions:
            Option<Vec<crate::telemetry_service::v1_1_6::CollectionFunction>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Triggers")]
        pub triggers: Option<crate::odata_v4::IdRef>,
    }
}
pub mod v1_2_4 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::telemetry_service::v1_2_4::OemActions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#TelemetryService.SubmitTestMetricReport"
        )]
        pub telemetry_service_submit_test_metric_report:
            Option<crate::telemetry_service::v1_2_4::SubmitTestMetricReport>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum CollectionFunction {
        #[default]
    ...
    pub struct SubmitTestMetricReportRequestBody {
        #[serde(rename = "GeneratedMetricReportValues")]
        pub generated_metric_report_values: Vec<crate::telemetry_service::v1_2_4::MetricValue>,
        #[serde(rename = "MetricReportName")]
        pub metric_report_name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MetricReportValues")]
        pub metric_report_values: Option<String>,
    ...
    pub struct TelemetryService {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::telemetry_service::v1_2_4::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(rename = "Id")]
        pub id: String,
        ...
        pub supported_collection_functions:
            Option<Vec<crate::telemetry_service::v1_2_4::CollectionFunction>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Triggers")]
        pub triggers: Option<crate::odata_v4::IdRef>,
    }
}

pub type Port = crate::port::v1_17_0::Port;
pub mod v1_16_0 {
    ...
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct SFP {
        #[serde(skip_serializing_if = "Option::is_none", rename = "DateCode")]
...
pub mod v1_17_0 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::port::v1_17_0::OemActions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "#Port.Reset")]
        pub port_reset: Option<crate::port::v1_17_0::Reset>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "#Port.ResetPPB")]
        pub port_reset_ppb: Option<crate::port::v1_17_0::ResetPPB>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct CXL {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Congestion")]
        pub congestion: Option<crate::port::v1_17_0::CXLCongestion>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "ConnectedDeviceMode"
        )]
        pub connected_device_mode: Option<crate::port::v1_17_0::CXLConnectedDeviceMode>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "ConnectedDeviceType"
        )]
        pub connected_device_type: Option<crate::port::v1_17_0::CXLConnectedDeviceType>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "CurrentPortConfigurationState"
        )]
        pub current_port_configuration_state:
            Option<crate::port::v1_17_0::CXLCurrentPortConfigurationState>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "MaxLogicalDeviceCount"
        )]
        ...
        pub qos_telemetry_capabilities: Option<crate::port::v1_17_0::CXLQoSTelemetryCapabilities>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SupportedCXLModes")]
        pub supported_cxl_modes: Option<Vec<crate::port::v1_17_0::CXLSupportedCXLModes>>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "TemporaryThroughputReductionEnabled"
        )]
    ...
    #[serde(untagged)]
    pub enum CXLCongestion {
        V011700(crate::port::v1_17_0::Congestion),
        V000001(crate::port::v1_17_0::CXLCongestionN1),
    }
    impl Default for CXLCongestion {
        fn default() -> Self {
    ...
    #[serde(untagged)]
    pub enum CXLConnectedDeviceMode {
        V011700(crate::port::v1_17_0::ConnectedDeviceMode),
        V000001(crate::port::v1_17_0::CXLConnectedDeviceModeN1),
    }
    impl Default for CXLConnectedDeviceMode {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum CXLConnectedDeviceType {
        V011700(crate::port::v1_17_0::ConnectedDeviceType),
        V000001(crate::port::v1_17_0::CXLConnectedDeviceTypeN1),
    }
    impl Default for CXLConnectedDeviceType {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum CXLCurrentPortConfigurationState {
        V011700(crate::port::v1_17_0::CurrentPortConfigurationState),
        V000001(crate::port::v1_17_0::CXLCurrentPortConfigurationStateN1),
    }
    impl Default for CXLCurrentPortConfigurationState {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum CXLQoSTelemetryCapabilities {
        V011700(crate::port::v1_17_0::QoSTelemetryCapabilities),
        V000001(crate::port::v1_17_0::CXLQoSTelemetryCapabilitiesN1),
    }
    impl Default for CXLQoSTelemetryCapabilities {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub enum CXLSupportedCXLModes {
        V011700(crate::port::v1_17_0::ConnectedDeviceMode),
        V000001(crate::port::v1_17_0::CXLSupportedCXLModesN1),
    }
    impl Default for CXLSupportedCXLModes {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub struct EthernetProperties {
        ...
        pub flow_control_configuration:
            Option<crate::port::v1_17_0::EthernetPropertiesFlowControlConfiguration>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "FlowControlStatus")]
        pub flow_control_status: Option<crate::port::v1_17_0::EthernetPropertiesFlowControlStatus>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LLDPEnabled")]
        pub lldp_enabled: Option<bool>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LLDPReceive")]
        pub lldp_receive: Option<crate::port::v1_17_0::EthernetPropertiesLLDPReceive>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LLDPTransmit")]
        pub lldp_transmit: Option<crate::port::v1_17_0::EthernetPropertiesLLDPTransmit>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "SupportedEthernetCapabilities"
        )]
        pub supported_ethernet_capabilities:
            Option<Vec<crate::port::v1_17_0::EthernetPropertiesSupportedEthernetCapabilities>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "WakeOnLANEnabled")]
        pub wake_on_lan_enabled: Option<bool>,
    }
    #[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
    #[serde(untagged)]
    pub enum EthernetPropertiesFlowControlConfiguration {
        V011700(crate::port::v1_17_0::FlowControl),
        V000001(crate::port::v1_17_0::EthernetPropertiesFlowControlConfigurationN1),
    }
    impl Default for EthernetPropertiesFlowControlConfiguration {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub enum EthernetPropertiesFlowControlStatus {
        V011700(crate::port::v1_17_0::FlowControl),
        V000001(crate::port::v1_17_0::EthernetPropertiesFlowControlStatusN1),
    }
    impl Default for EthernetPropertiesFlowControlStatus {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum EthernetPropertiesLLDPReceive {
        V011700(crate::port::v1_17_0::LLDPReceive),
        V000001(crate::port::v1_17_0::EthernetPropertiesLLDPReceiveN1),
    }
    impl Default for EthernetPropertiesLLDPReceive {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum EthernetPropertiesLLDPTransmit {
        V011700(crate::port::v1_17_0::LLDPTransmit),
        V000001(crate::port::v1_17_0::EthernetPropertiesLLDPTransmitN1),
    }
    impl Default for EthernetPropertiesLLDPTransmit {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum EthernetPropertiesSupportedEthernetCapabilities {
        V011700(crate::port::v1_17_0::SupportedEthernetCapabilities),
        V000001(crate::port::v1_17_0::EthernetPropertiesSupportedEthernetCapabilitiesN1),
    }
    impl Default for EthernetPropertiesSupportedEthernetCapabilities {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub struct FibreChannelProperties {
        ...
        #[serde(skip_serializing_if = "Option::is_none", rename = "PortConnectionType")]
        pub port_connection_type:
            Option<crate::port::v1_17_0::FibreChannelPropertiesPortConnectionType>,
    }
    #[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
    #[serde(untagged)]
    pub enum FibreChannelPropertiesPortConnectionType {
        V011700(crate::port::v1_17_0::PortConnectionType),
        V000001(crate::port::v1_17_0::FibreChannelPropertiesPortConnectionTypeN1),
    }
    impl Default for FibreChannelPropertiesPortConnectionType {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub struct LLDPReceive {
        ...
        pub chassis_id: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ChassisIdSubtype")]
        pub chassis_id_subtype: Option<crate::port::v1_17_0::LLDPReceiveChassisIdSubtype>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "ManagementAddressIPv4"
        )]
        ...
        pub port_id: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "PortIdSubtype")]
        pub port_id_subtype: Option<crate::port::v1_17_0::LLDPReceivePortIdSubtype>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SystemCapabilities")]
        pub system_capabilities: Option<Vec<crate::port::v1_17_0::LLDPReceiveSystemCapabilities>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SystemDescription")]
        pub system_description: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SystemName")]
        pub system_name: Option<String>,
    ...
    #[serde(untagged)]
    pub enum LLDPReceiveChassisIdSubtype {
        V011700(crate::port::v1_17_0::IEEE802IdSubtype),
        V000001(crate::port::v1_17_0::LLDPReceiveChassisIdSubtypeN1),
    }
    impl Default for LLDPReceiveChassisIdSubtype {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub enum LLDPReceivePortIdSubtype {
        V011700(crate::port::v1_17_0::IEEE802IdSubtype),
        V000001(crate::port::v1_17_0::LLDPReceivePortIdSubtypeN1),
    }
    impl Default for LLDPReceivePortIdSubtype {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum LLDPReceiveSystemCapabilities {
        V011700(crate::port::v1_17_0::LLDPSystemCapabilities),
        V000001(crate::port::v1_17_0::LLDPReceiveSystemCapabilitiesN1),
    }
    impl Default for LLDPReceiveSystemCapabilities {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub struct LLDPTransmit {
        ...
        pub chassis_id: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ChassisIdSubtype")]
        pub chassis_id_subtype: Option<crate::port::v1_17_0::LLDPTransmitChassisIdSubtype>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "ManagementAddressIPv4"
        )]
        ...
        pub port_id: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "PortIdSubtype")]
        pub port_id_subtype: Option<crate::port::v1_17_0::LLDPTransmitPortIdSubtype>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SystemCapabilities")]
        pub system_capabilities: Option<Vec<crate::port::v1_17_0::LLDPTransmitSystemCapabilities>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SystemDescription")]
        pub system_description: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SystemName")]
        pub system_name: Option<String>,
    ...
    pub enum LLDPTransmitChassisIdSubtype {
        V011700(crate::port::v1_17_0::IEEE802IdSubtype),
        V000001(crate::port::v1_17_0::LLDPTransmitChassisIdSubtypeN1),
    }
    impl Default for LLDPTransmitChassisIdSubtype {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub enum LLDPTransmitPortIdSubtype {
        V011700(crate::port::v1_17_0::IEEE802IdSubtype),
        V000001(crate::port::v1_17_0::LLDPTransmitPortIdSubtypeN1),
    }
    impl Default for LLDPTransmitPortIdSubtype {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub enum LLDPTransmitSystemCapabilities {
        V011700(crate::port::v1_17_0::LLDPSystemCapabilities),
        V000001(crate::port::v1_17_0::LLDPTransmitSystemCapabilitiesN1),
    }
    impl Default for LLDPTransmitSystemCapabilities {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub struct LinkConfiguration {
        ...
        pub configured_network_links:
            Option<Vec<crate::port::v1_17_0::LinkConfigurationConfiguredNetworkLinks>>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "LinkNetworkTechnology"
        )]
        pub link_network_technology:
            Option<crate::port::v1_17_0::LinkConfigurationLinkNetworkTechnology>,
    }
    #[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
    #[serde(untagged)]
    pub enum LinkConfigurationConfiguredNetworkLinks {
        V011700(crate::port::v1_17_0::ConfiguredNetworkLink),
        V000001(crate::port::v1_17_0::LinkConfigurationConfiguredNetworkLinksN1),
    }
    impl Default for LinkConfigurationConfiguredNetworkLinks {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum LinkConfigurationLinkNetworkTechnology {
        V011700(crate::port::v1_17_0::LinkNetworkTechnology),
        V000001(crate::port::v1_17_0::LinkConfigurationLinkNetworkTechnologyN1),
    }
    impl Default for LinkConfigurationLinkNetworkTechnology {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub struct Port {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::port::v1_17_0::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ActiveWidth")]
        pub active_width: Option<i64>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "AssociatedPhysicalPort"
        )]
        pub associated_physical_port: Option<i64>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "CapableProtocolVersions"
        )]
        ...
        pub current_speed_gbps: Option<f64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "CXL")]
        pub cxl: Option<crate::port::v1_17_0::PortCXL>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::port::v1_17_0::PortDescription>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Enabled")]
        pub enabled: Option<bool>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "EnvironmentMetrics")]
        pub environment_metrics: Option<crate::odata_v4::IdRef>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Ethernet")]
        pub ethernet: Option<crate::port::v1_17_0::PortEthernet>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "FibreChannel")]
        pub fibre_channel: Option<crate::port::v1_17_0::PortFibreChannel>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "FirstLane")]
        pub first_lane: Option<i64>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "FunctionMaxBandwidth"
        )]
        pub function_max_bandwidth: Option<Vec<crate::port::v1_17_0::FunctionMaxBandwidth>>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "FunctionMinBandwidth"
        )]
        pub function_min_bandwidth: Option<Vec<crate::port::v1_17_0::FunctionMinBandwidth>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "GenZ")]
        pub gen_z: Option<crate::port::v1_17_0::GenZ>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "HostDevice")]
        pub host_device: Option<crate::port::v1_17_0::PortHostDevice>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "InfiniBand")]
        pub infini_band: Option<crate::port::v1_17_0::PortInfiniBand>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "InterfaceEnabled")]
        pub interface_enabled: Option<bool>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "IsSplit")]
        pub is_split: Option<bool>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LinkConfiguration")]
        pub link_configuration: Option<Vec<crate::port::v1_17_0::LinkConfiguration>>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "LinkNetworkTechnology"
        )]
        pub link_network_technology: Option<crate::port::v1_17_0::PortLinkNetworkTechnology>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LinkState")]
        pub link_state: Option<crate::port::v1_17_0::LinkState>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LinkStatus")]
        pub link_status: Option<crate::port::v1_17_0::LinkStatus>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "LinkTransitionIndicator"
        )]
        pub link_transition_indicator: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::port::v1_17_0::Links>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Location")]
        pub location: Option<crate::resource::Location>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub max_speed_gbps: Option<f64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Metrics")]
        pub metrics: Option<crate::port::v1_17_0::PortMetrics>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,
        ...
        pub port_id: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "PortMedium")]
        pub port_medium: Option<crate::port::v1_17_0::PortPortMedium>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "PortProtocol")]
        pub port_protocol: Option<crate::port::v1_17_0::PortPortProtocol>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "PortType")]
        pub port_type: Option<crate::port::v1_17_0::PortPortType>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "RemotePortId")]
        pub remote_port_id: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SFP")]
        pub sfp: Option<crate::port::v1_17_0::PortSFP>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SignalDetected")]
        pub signal_detected: Option<bool>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Status")]
        pub status: Option<crate::resource::Status>,
    ...
    #[serde(untagged)]
    pub enum PortCXL {
        V011700(crate::port::v1_17_0::CXL),
        V000001(crate::port::v1_17_0::PortCXLN1),
    }
    impl Default for PortCXL {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum PortDescription {
        V000001(crate::port::v1_17_0::PortDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for PortDescription {
        fn default() -> Self {
    ...
    #[serde(untagged)]
    pub enum PortEthernet {
        V011700(crate::port::v1_17_0::EthernetProperties),
        V000001(crate::port::v1_17_0::PortEthernetN1),
    }
    impl Default for PortEthernet {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum PortFibreChannel {
        V011700(crate::port::v1_17_0::FibreChannelProperties),
        V000001(crate::port::v1_17_0::PortFibreChannelN1),
    }
    impl Default for PortFibreChannel {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum PortHostDevice {
        V011700(crate::port::v1_17_0::HostDeviceType),
        V000001(crate::port::v1_17_0::PortHostDeviceN1),
    }
    impl Default for PortHostDevice {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum PortInfiniBand {
        V011700(crate::port::v1_17_0::InfiniBandProperties),
        V000001(crate::port::v1_17_0::PortInfiniBandN1),
    }
    impl Default for PortInfiniBand {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub enum PortLinkNetworkTechnology {
        V011700(crate::port::v1_17_0::LinkNetworkTechnology),
        V000001(crate::port::v1_17_0::PortLinkNetworkTechnologyN1),
    }
    impl Default for PortLinkNetworkTechnology {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum PortMetrics {
        V000001(crate::port::v1_17_0::PortMetricsN1),
        OdataV4IdRef(crate::odata_v4::IdRef),
    }
    impl Default for PortMetrics {
        fn default() -> Self {
    ...
    #[serde(untagged)]
    pub enum PortPortMedium {
        V011700(crate::port::v1_17_0::PortMedium),
        V000001(crate::port::v1_17_0::PortPortMediumN1),
    }
    impl Default for PortPortMedium {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum PortPortProtocol {
        V000001(crate::port::v1_17_0::PortPortProtocolN1),
        ProtocolProtocol(crate::protocol::Protocol),
    }
    impl Default for PortPortProtocol {
        fn default() -> Self {
    ...
    #[serde(untagged)]
    pub enum PortPortType {
        V011700(crate::port::v1_17_0::PortType),
        V000001(crate::port::v1_17_0::PortPortTypeN1),
    }
    impl Default for PortPortType {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum PortSFP {
        V011700(crate::port::v1_17_0::SFP),
        V000001(crate::port::v1_17_0::PortSFPN1),
    }
    impl Default for PortSFP {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub struct SFP {
        ...
        pub fiber_connection_type: Option<crate::port::v1_17_0::SFPFiberConnectionType>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Manufacturer")]
        pub manufacturer: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MediumType")]
        pub medium_type: Option<crate::port::v1_17_0::SFPMediumType>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "PartNumber")]
        pub part_number: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SerialNumber")]
        pub serial_number: Option<String>,
        ...
        pub status: Option<crate::resource::Status>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SupportedSFPTypes")]
        pub supported_sfp_types: Option<Vec<crate::port::v1_17_0::SFPSupportedSFPTypes>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Type")]
        pub r#type: Option<crate::port::v1_17_0::SFPTypeAnony>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "VendorOUI")]
        pub vendor_oui: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Version")]
        pub version: Option<String>,
    ...
    #[serde(untagged)]
    pub enum SFPFiberConnectionType {
        V011700(crate::port::v1_17_0::FiberConnectionType),
        V000001(crate::port::v1_17_0::SFPFiberConnectionTypeN1),
    }
    impl Default for SFPFiberConnectionType {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum SFPMediumType {
        V011700(crate::port::v1_17_0::MediumType),
        V000001(crate::port::v1_17_0::SFPMediumTypeN1),
    }
    impl Default for SFPMediumType {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    #[serde(untagged)]
    pub enum SFPSupportedSFPTypes {
        V011700(crate::port::v1_17_0::SFPType),
        V000001(crate::port::v1_17_0::SFPSupportedSFPTypesN1),
    }
    impl Default for SFPSupportedSFPTypes {
        fn default() -> Self {
            Self::V011700(Default::default())
    ...
    pub enum SFPTypeAnony {
        V011700(crate::port::v1_17_0::SFPType),
        V000001(crate::port::v1_17_0::SFPTypeN1),
    }
    impl Default for SFPTypeAnony {
        fn default() -> Self {
            Self::V011700(Default::default())

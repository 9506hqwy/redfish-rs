pub type SwitchMetrics = crate::switch_metrics::v1_1_0::SwitchMetrics;
pub mod v1_0_2 {
...
pub mod v1_1_0 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::switch_metrics::v1_1_0::OemActions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#SwitchMetrics.ClearCurrentPeriod"
        )]
        pub switch_metrics_clear_current_period:
            Option<crate::switch_metrics::v1_1_0::ClearCurrentPeriod>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct ClearCurrentPeriod {
        #[serde(skip_serializing_if = "Option::is_none", rename = "target")]
    ...
    pub struct InternalMemoryMetrics {
        #[serde(skip_serializing_if = "Option::is_none", rename = "CurrentPeriod")]
        pub current_period: Option<crate::switch_metrics::v1_1_0::CurrentPeriod>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LifeTime")]
        pub life_time: Option<crate::switch_metrics::v1_1_0::LifeTime>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct LifeTime {
        #[serde(
    ...
    pub struct SwitchMetrics {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::switch_metrics::v1_1_0::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::switch_metrics::v1_1_0::SwitchMetricsDescription>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub internal_memory_metrics: Option<crate::switch_metrics::v1_1_0::InternalMemoryMetrics>,
        #[serde(
            skip_serializing_if = "Option::is_none",
    ...
    #[serde(untagged)]
    pub enum SwitchMetricsDescription {
        V000001(crate::switch_metrics::v1_1_0::SwitchMetricsDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for SwitchMetricsDescription {
        fn default() -> Self {

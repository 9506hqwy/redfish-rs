...
#[serde(untagged)]
pub enum MessageRegistryFile {
    V010103(crate::message_registry_file::v1_1_3::MessageRegistryFile),
    V010007(crate::message_registry_file::v1_0_7::MessageRegistryFile),
...
pub mod v1_0_7 {
    ...
    pub struct MessageRegistryFile {
        ...
        pub location: Vec<crate::message_registry_file::v1_0_7::Location>,
        #[serde(rename = "Name")]
        pub name: String,

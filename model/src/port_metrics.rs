pub type PortMetrics = crate::port_metrics::v1_8_0::PortMetrics;
pub mod v1_7_0 {
...
pub mod v1_8_0 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::port_metrics::v1_8_0::OemActions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#PortMetrics.ResetMetrics"
        )]
        pub port_metrics_reset_metrics: Option<crate::port_metrics::v1_8_0::ResetMetrics>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct CXL {
        #[serde(
    ...
    pub struct PortMetrics {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::port_metrics::v1_8_0::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "CXL")]
        pub cxl: Option<crate::port_metrics::v1_8_0::CXL>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::port_metrics::v1_8_0::PortMetricsDescription>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "FibreChannel")]
        pub fibre_channel: Option<crate::port_metrics::v1_8_0::FibreChannel>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "GenZ")]
        pub gen_z: Option<crate::port_metrics::v1_8_0::GenZ>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Networking")]
        pub networking: Option<crate::port_metrics::v1_8_0::Networking>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.etag")]
        pub odata_etag: Option<String>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", rename = "PCIeErrors")]
        pub pcie_errors: Option<crate::pcie_device::PCIeErrors>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "PCIeMetrics")]
        pub pcie_metrics: Option<crate::pcie_device::PCIeMetrics>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "RXBytes")]
        pub rx_bytes: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "RXErrors")]
        pub rx_errors: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SAS")]
        pub sas: Option<Vec<crate::port_metrics::v1_8_0::SAS>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Transceivers")]
        pub transceivers: Option<Vec<crate::port_metrics::v1_8_0::Transceiver>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "TXBytes")]
        pub tx_bytes: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "TXErrors")]
        pub tx_errors: Option<i64>,
    ...
    #[serde(untagged)]
    pub enum PortMetricsDescription {
        V000001(crate::port_metrics::v1_8_0::PortMetricsDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for PortMetricsDescription {
        fn default() -> Self {
    ...
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Transceiver {
        #[serde(skip_serializing_if = "Option::is_none", rename = "ByLane")]
        pub by_lane: Option<Vec<crate::port_metrics::v1_8_0::TransceiverLaneMetrics>>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "RXInputPowerMilliWatts"
        )]
    ...
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct TransceiverLaneMetrics {
        #[serde(skip_serializing_if = "Option::is_none", rename = "LaneId")]

...
#[serde(untagged)]
pub enum Key {
    V010200(crate::key::v1_2_0::Key),
    V010100(crate::key::v1_1_0::Key),
    V010000(crate::key::v1_0_0::Key),
...
pub mod v1_0_0 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::key::v1_0_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Key {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::key::v1_0_0::Actions>,
        ...
        pub key_type: Option<crate::key::v1_0_0::KeyType>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "NVMeoF")]
        pub nvme_of: Option<crate::key::v1_0_0::NVMeoF>,
    ...
    pub struct NVMeoF {
        ...
        pub secure_hash_allow_list: Option<Vec<crate::key::v1_0_0::NVMeoFSecureHashType>>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "SecurityProtocolType"
        )]
        pub security_protocol_type: Option<crate::key::v1_0_0::NVMeoFSecurityProtocolType>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
...
pub mod v1_1_0 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::key::v1_1_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Key {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::key::v1_1_0::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(rename = "Id")]
        pub id: String,
        ...
        pub key_string: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "KeyType")]
        pub key_type: Option<crate::key::v1_1_0::KeyType>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "NVMeoF")]
        pub nvme_of: Option<crate::key::v1_1_0::NVMeoF>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.etag")]
        pub odata_etag: Option<String>,
    ...
    pub struct NVMeoF {
        ...
        pub secure_hash_allow_list: Option<Vec<crate::key::v1_1_0::NVMeoFSecureHashType>>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "SecurityProtocolType"
        )]
        pub security_protocol_type: Option<crate::key::v1_1_0::NVMeoFSecurityProtocolType>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum NVMeoFSecureHashType {
        #[default]

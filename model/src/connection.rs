...
#[serde(untagged)]
pub enum Connection {
    V010200(crate::connection::v1_2_0::Connection),
    V010100(crate::connection::v1_1_0::Connection),
    V010000(crate::connection::v1_0_0::Connection),
...
pub mod v1_0_0 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::connection::v1_0_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Connection {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::connection::v1_0_0::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ConnectionType")]
        pub connection_type: Option<crate::connection::v1_0_0::ConnectionType>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::connection::v1_0_0::Links>,
        #[serde(rename = "Name")]
        pub name: String,
        ...
        pub volume_info: Option<Vec<crate::connection::v1_0_0::VolumeInfo>>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct VolumeInfo {
        ...
        pub access_capabilities: Option<Vec<crate::connection::v1_0_0::AccessCapability>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "AccessState")]
        pub access_state: Option<crate::connection::v1_0_0::AccessState>,
...
pub mod v1_1_0 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::connection::v1_1_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Connection {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::connection::v1_1_0::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ConnectionKeys")]
        pub connection_keys: Option<crate::connection::v1_1_0::ConnectionKey>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ConnectionType")]
        pub connection_type: Option<crate::connection::v1_1_0::ConnectionType>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::connection::v1_1_0::Links>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MemoryChunkInfo")]
        pub memory_chunk_info: Option<Vec<crate::connection::v1_1_0::MemoryChunkInfo>>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,
        ...
        pub status: Option<crate::resource::Status>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "VolumeInfo")]
        pub volume_info: Option<Vec<crate::connection::v1_1_0::VolumeInfo>>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct ConnectionKey {
        #[serde(skip_serializing_if = "Option::is_none", rename = "GenZ")]
        pub gen_z: Option<crate::connection::v1_1_0::GenZConnectionKey>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum ConnectionType {
        #[default]
    ...
    pub struct MemoryChunkInfo {
        #[serde(skip_serializing_if = "Option::is_none", rename = "AccessCapabilities")]
        pub access_capabilities: Option<Vec<crate::connection::v1_1_0::AccessCapability>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "AccessState")]
        pub access_state: Option<crate::connection::v1_1_0::AccessState>,

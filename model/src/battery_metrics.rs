pub type BatteryMetrics = crate::battery_metrics::v1_1_0::BatteryMetrics;
pub mod v1_0_4 {
...
pub mod v1_1_0 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::battery_metrics::v1_1_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct BatteryMetrics {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::battery_metrics::v1_1_0::Actions>,
        ...
        pub charge_percent: Option<crate::sensor::SensorExcerpt>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::battery_metrics::v1_1_0::BatteryMetricsDescription>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "DischargeCycles")]
        pub discharge_cycles: Option<f64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ERate")]
        pub e_rate: Option<f64>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "InputCurrentAmps")]
        pub input_current_amps: Option<crate::sensor::SensorCurrentExcerpt>,
    ...
    #[serde(untagged)]
    pub enum BatteryMetricsDescription {
        V000001(crate::battery_metrics::v1_1_0::BatteryMetricsDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for BatteryMetricsDescription {
        fn default() -> Self {

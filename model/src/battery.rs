pub type Battery = crate::battery::v1_5_0::Battery;
pub mod v1_4_0 {
...
pub mod v1_5_0 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "#Battery.Calibrate")]
        pub battery_calibrate: Option<crate::battery::v1_5_0::Calibrate>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "#Battery.Reset")]
        pub battery_reset: Option<crate::battery::v1_5_0::Reset>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "#Battery.SelfTest")]
        pub battery_self_test: Option<crate::battery::v1_5_0::SelfTest>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::battery::v1_5_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Battery {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::battery::v1_5_0::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Assembly")]
        pub assembly: Option<crate::odata_v4::IdRef>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub battery_chemistry_type: Option<crate::battery::v1_5_0::BatteryBatteryChemistryType>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "CapacityActualAmpHours"
        )]
        ...
        pub capacity_rated_watt_hours: Option<f64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ChargeState")]
        pub charge_state: Option<crate::battery::v1_5_0::BatteryChargeState>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::battery::v1_5_0::BatteryDescription>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "EnergyStorageType")]
        pub energy_storage_type: Option<crate::battery::v1_5_0::BatteryEnergyStorageType>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "FirmwareVersion")]
        pub firmware_version: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "HotPluggable")]
        pub hot_pluggable: Option<bool>,
        ...
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::battery::v1_5_0::Links>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Location")]
        pub location: Option<crate::resource::Location>,
        #[serde(
            skip_serializing_if = "Option::is_none",
    ...
    #[serde(untagged)]
    pub enum BatteryBatteryChemistryType {
        V010500(crate::battery::v1_5_0::BatteryChemistryType),
        V000001(crate::battery::v1_5_0::BatteryBatteryChemistryTypeN1),
    }
    impl Default for BatteryBatteryChemistryType {
        fn default() -> Self {
    ...
    #[serde(untagged)]
    pub enum BatteryChargeState {
        V010500(crate::battery::v1_5_0::ChargeState),
        V000001(crate::battery::v1_5_0::BatteryChargeStateN1),
    }
    impl Default for BatteryChargeState {
        fn default() -> Self {
            Self::V010500(Default::default())
    ...
    #[serde(untagged)]
    pub enum BatteryDescription {
        V000001(crate::battery::v1_5_0::BatteryDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for BatteryDescription {
        fn default() -> Self {
    ...
    #[serde(untagged)]
    pub enum BatteryEnergyStorageType {
        V010500(crate::battery::v1_5_0::EnergyStorageType),
        V000001(crate::battery::v1_5_0::BatteryEnergyStorageTypeN1),
    }
    impl Default for BatteryEnergyStorageType {
        fn default() -> Self {
            Self::V010500(Default::default())

...
#[serde(untagged)]
pub enum Battery {
    V010201(crate::battery::v1_2_1::Battery),
    V010101(crate::battery::v1_1_1::Battery),
    V010002(crate::battery::v1_0_2::Battery),
...
pub mod v1_0_2 {
    ...
    pub struct Actions {
        ...
        pub battery_calibrate: Option<crate::battery::v1_0_2::Calibrate>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "#Battery.Reset")]
        pub battery_reset: Option<crate::battery::v1_0_2::Reset>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "#Battery.SelfTest")]
        pub battery_self_test: Option<crate::battery::v1_0_2::SelfTest>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::battery::v1_0_2::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Battery {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::battery::v1_0_2::Actions>,
        ...
        pub charge_state: Option<crate::battery::v1_0_2::ChargeState>,
...
pub mod v1_1_1 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "#Battery.Calibrate")]
        pub battery_calibrate: Option<crate::battery::v1_1_1::Calibrate>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "#Battery.Reset")]
        pub battery_reset: Option<crate::battery::v1_1_1::Reset>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "#Battery.SelfTest")]
        pub battery_self_test: Option<crate::battery::v1_1_1::SelfTest>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::battery::v1_1_1::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Battery {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::battery::v1_1_1::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Assembly")]
        pub assembly: Option<crate::odata_v4::IdRef>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub capacity_rated_watt_hours: Option<f64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ChargeState")]
        pub charge_state: Option<crate::battery::v1_1_1::ChargeState>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "FirmwareVersion")]
        pub firmware_version: Option<String>,
        ...
        pub links: Option<crate::battery::v1_1_1::Links>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Location")]
        pub location: Option<crate::resource::Location>,
        #[serde(
            skip_serializing_if = "Option::is_none",

pub type NetworkInterface = crate::network_interface::v1_2_3::NetworkInterface;
pub mod v1_2_3 {
    use serde::{Deserialize, Serialize};
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::network_interface::v1_2_3::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Links {
    ...
    pub struct NetworkInterface {
        ...
        pub actions: Option<crate::network_interface::v1_2_3::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::network_interface::v1_2_3::NetworkInterfaceDescription>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::network_interface::v1_2_3::Links>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(
    ...
    pub enum NetworkInterfaceDescription {
        V000001(crate::network_interface::v1_2_3::NetworkInterfaceDescriptionN1),

...
pub enum NetworkInterface {
    V010201(crate::network_interface::v1_2_1::NetworkInterface),
    V010105(crate::network_interface::v1_1_5::NetworkInterface),
    V010006(crate::network_interface::v1_0_6::NetworkInterface),
...
pub mod v1_0_6 {
    ...
    pub struct NetworkInterface {
        ...
        pub links: Option<crate::network_interface::v1_0_6::Links>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(
...
pub mod v1_1_5 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::network_interface::v1_1_5::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Links {
        #[serde(skip_serializing_if = "Option::is_none", rename = "NetworkAdapter")]
    ...
    pub struct NetworkInterface {
        ...
        pub actions: Option<crate::network_interface::v1_1_5::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::network_interface::v1_1_5::Links>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(
            skip_serializing_if = "Option::is_none",

pub type PowerEquipment = crate::power_equipment::v1_2_3::PowerEquipment;
pub mod v1_2_3 {
    use serde::{Deserialize, Serialize};
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::power_equipment::v1_2_3::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Links {
    ...
    pub struct PowerEquipment {
        ...
        pub actions: Option<crate::power_equipment::v1_2_3::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::power_equipment::v1_2_3::PowerEquipmentDescription>,
        ...
        pub links: Option<crate::power_equipment::v1_2_3::Links>,
        #[serde(rename = "Name")]
        pub name: String,
    ...
    pub enum PowerEquipmentDescription {
        V000001(crate::power_equipment::v1_2_3::PowerEquipmentDescriptionN1),

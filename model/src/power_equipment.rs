...
#[serde(untagged)]
pub enum PowerEquipment {
    V010200(crate::power_equipment::v1_2_0::PowerEquipment),
    V010100(crate::power_equipment::v1_1_0::PowerEquipment),
    V010000(crate::power_equipment::v1_0_0::PowerEquipment),
...
pub mod v1_0_0 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::power_equipment::v1_0_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Links {
    ...
    pub struct PowerEquipment {
        ...
        pub actions: Option<crate::power_equipment::v1_0_0::Actions>,
        ...
        pub links: Option<crate::power_equipment::v1_0_0::Links>,
        #[serde(rename = "Name")]
        pub name: String,
...
pub mod v1_1_0 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::power_equipment::v1_1_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Links {
        #[serde(skip_serializing_if = "Option::is_none", rename = "ManagedBy")]
    ...
    pub struct PowerEquipment {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::power_equipment::v1_1_0::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "FloorPDUs")]
        pub floor_pd_us: Option<crate::odata_v4::IdRef>,
        ...
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::power_equipment::v1_1_0::Links>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,

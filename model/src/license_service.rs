...
pub mod v1_1_2 {
    ...
    pub struct Actions {
        ...
        pub license_service_install: Option<crate::license_service::v1_1_2::Install>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::license_service::v1_1_2::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Install {
    ...
    pub struct InstallRequestBody {
        ...
        pub transfer_protocol: Option<crate::license_service::v1_1_2::TransferProtocolType>,
    ...
    pub struct LicenseService {
        ...
        pub actions: Option<crate::license_service::v1_1_2::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::license_service::v1_1_2::LicenseServiceDescription>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(
            skip_serializing_if = "Option::is_none",
    ...
    #[serde(untagged)]
    pub enum LicenseServiceDescription {
        V000001(crate::license_service::v1_1_2::LicenseServiceDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for LicenseServiceDescription {
        fn default() -> Self {
            Self::V000001(Default::default())
        }
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum LicenseServiceDescriptionN1 {
        #[default]
        #[serde(rename = "null")]
        Null,
    }

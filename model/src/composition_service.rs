...
#[serde(untagged)]
pub enum CompositionService {
    V010201(crate::composition_service::v1_2_1::CompositionService),
    V010103(crate::composition_service::v1_1_3::CompositionService),
    V010005(crate::composition_service::v1_0_5::CompositionService),
...
pub mod v1_0_5 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::composition_service::v1_0_5::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct CompositionService {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::composition_service::v1_0_5::Actions>,
...
pub mod v1_1_3 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::composition_service::v1_1_3::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct CompositionService {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::composition_service::v1_1_3::Actions>,
        #[serde(

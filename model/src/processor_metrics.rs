pub type ProcessorMetrics = crate::processor_metrics::v1_7_0::ProcessorMetrics;
pub mod v1_6_4 {
...
pub mod v1_7_0 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::processor_metrics::v1_7_0::OemActions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#ProcessorMetrics.ClearCurrentPeriod"
        )]
        pub processor_metrics_clear_current_period:
            Option<crate::processor_metrics::v1_7_0::ClearCurrentPeriod>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct CStateResidency {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Level")]
    ...
    pub struct CacheMetricsTotal {
        #[serde(skip_serializing_if = "Option::is_none", rename = "CurrentPeriod")]
        pub current_period: Option<crate::processor_metrics::v1_7_0::CurrentPeriod>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LifeTime")]
        pub life_time: Option<crate::processor_metrics::v1_7_0::LifeTime>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct ClearCurrentPeriod {
        #[serde(skip_serializing_if = "Option::is_none", rename = "target")]
    ...
    pub struct CoreMetrics {
        #[serde(skip_serializing_if = "Option::is_none", rename = "CStateResidency")]
        pub c_state_residency: Option<Vec<crate::processor_metrics::v1_7_0::CStateResidency>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "CoreCache")]
        pub core_cache: Option<Vec<crate::processor_metrics::v1_7_0::CacheMetrics>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "CoreId")]
        pub core_id: Option<String>,
        #[serde(
            skip_serializing_if = "Option::is_none",
    ...
    pub struct ProcessorMetrics {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::processor_metrics::v1_7_0::Actions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "AverageFrequencyMHz"
        )]
        ...
        pub bandwidth_percent: Option<f64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Cache")]
        pub cache: Option<Vec<crate::processor_metrics::v1_7_0::CacheMetrics>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "CacheMetricsTotal")]
        pub cache_metrics_total: Option<crate::processor_metrics::v1_7_0::CacheMetricsTotal>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ConsumedPowerWatt")]
        pub consumed_power_watt: Option<f64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "CoreMetrics")]
        pub core_metrics: Option<Vec<crate::processor_metrics::v1_7_0::CoreMetrics>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "CoreVoltage")]
        pub core_voltage: Option<crate::processor_metrics::v1_7_0::ProcessorMetricsCoreVoltage>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "CorrectableCoreErrorCount"
        )]
        ...
        pub correctable_other_error_count: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::processor_metrics::v1_7_0::ProcessorMetricsDescription>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "FrequencyRatio")]
        pub frequency_ratio: Option<f64>,
        #[serde(rename = "Id")]
        pub id: String,
    ...
    #[serde(untagged)]
    pub enum ProcessorMetricsCoreVoltage {
        V000001(crate::processor_metrics::v1_7_0::ProcessorMetricsCoreVoltageN1),
        SensorSensorVoltageExcerpt(crate::sensor::v1_9_3::SensorVoltageExcerpt),
    }
    impl Default for ProcessorMetricsCoreVoltage {
        fn default() -> Self {
    ...
    #[serde(untagged)]
    pub enum ProcessorMetricsDescription {
        V000001(crate::processor_metrics::v1_7_0::ProcessorMetricsDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for ProcessorMetricsDescription {
        fn default() -> Self {

pub type Coolant = crate::cooling_loop::v1_1_0::Coolant;
pub type CoolingLoop = crate::cooling_loop::v1_1_0::CoolingLoop;
pub mod v1_0_3 {
...
pub mod v1_1_0 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::cooling_loop::v1_1_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Coolant {
        #[serde(skip_serializing_if = "Option::is_none", rename = "AdditiveName")]
        ...
        pub additive_percent: Option<f64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "CoolantType")]
        pub coolant_type: Option<crate::cooling_loop::v1_1_0::CoolantCoolantType>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "DensityKgPerCubicMeter"
        )]
    ...
    #[serde(untagged)]
    pub enum CoolantCoolantType {
        V010100(crate::cooling_loop::v1_1_0::CoolantType),
        V000001(crate::cooling_loop::v1_1_0::CoolantCoolantTypeN1),
    }
    impl Default for CoolantCoolantType {
        fn default() -> Self {
    ...
    pub struct CoolingLoop {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::cooling_loop::v1_1_0::Actions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "ConsumingEquipmentNames"
        )]
        pub consuming_equipment_names: Option<Vec<String>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Coolant")]
        pub coolant: Option<crate::cooling_loop::v1_1_0::Coolant>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "CoolantLevelPercent"
        )]
        pub coolant_level_percent:
            Option<crate::cooling_loop::v1_1_0::CoolingLoopCoolantLevelPercent>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "CoolantLevelStatus")]
        pub coolant_level_status:
            Option<crate::cooling_loop::v1_1_0::CoolingLoopCoolantLevelStatus>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "CoolantQuality")]
        pub coolant_quality: Option<crate::cooling_loop::v1_1_0::CoolingLoopCoolantQuality>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "CoolingLoopType")]
        pub cooling_loop_type: Option<crate::cooling_loop::v1_1_0::CoolingLoopCoolingLoopType>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "CoolingManagerURI")]
        pub cooling_manager_uri: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::cooling_loop::v1_1_0::CoolingLoopDescription>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::cooling_loop::v1_1_0::Links>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "LocationIndicatorActive"
        )]
    ...
    #[serde(untagged)]
    pub enum CoolingLoopCoolantLevelPercent {
        V000001(crate::cooling_loop::v1_1_0::CoolingLoopCoolantLevelPercentN1),
        SensorSensorExcerpt(crate::sensor::v1_9_3::SensorExcerpt),
    }
    impl Default for CoolingLoopCoolantLevelPercent {
        fn default() -> Self {
    ...
    #[serde(untagged)]
    pub enum CoolingLoopCoolantLevelStatus {
        V000001(crate::cooling_loop::v1_1_0::CoolingLoopCoolantLevelStatusN1),
        ResourceHealth(crate::resource::Health),
    }
    impl Default for CoolingLoopCoolantLevelStatus {
        fn default() -> Self {
    ...
    #[serde(untagged)]
    pub enum CoolingLoopCoolantQuality {
        V000001(crate::cooling_loop::v1_1_0::CoolingLoopCoolantQualityN1),
        ResourceHealth(crate::resource::Health),
    }
    impl Default for CoolingLoopCoolantQuality {
        fn default() -> Self {
    ...
    #[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
    #[serde(untagged)]
    pub enum CoolingLoopCoolingLoopType {
        V010100(crate::cooling_loop::v1_1_0::CoolingLoopType),
        V000001(crate::cooling_loop::v1_1_0::CoolingLoopCoolingLoopTypeN1),
    }
    impl Default for CoolingLoopCoolingLoopType {
        fn default() -> Self {
            Self::V010100(Default::default())
        }
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum CoolingLoopCoolingLoopTypeN1 {
        #[default]
        #[serde(rename = "null")]
        Null,
    }
    ...
    #[serde(untagged)]
    pub enum CoolingLoopDescription {
        V000001(crate::cooling_loop::v1_1_0::CoolingLoopDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for CoolingLoopDescription {
        fn default() -> Self {
    ...
    pub struct Links {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Chassis")]
        pub chassis: Option<crate::cooling_loop::v1_1_0::LinksChassis>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Facility")]
        pub facility: Option<crate::odata_v4::IdRef>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ManagedBy")]
        pub managed_by: Option<Vec<crate::odata_v4::IdRef>>,
    ...
    #[serde(untagged)]
    pub enum LinksChassis {
        V000001(crate::cooling_loop::v1_1_0::LinksChassisN1),
        OdataV4IdRef(crate::odata_v4::IdRef),
    }
    impl Default for LinksChassis {
        fn default() -> Self {

...
#[serde(untagged)]
pub enum SimpleStorage {
    V010301(crate::simple_storage::v1_3_1::SimpleStorage),
    V010204(crate::simple_storage::v1_2_4::SimpleStorage),
    V010106(crate::simple_storage::v1_1_6::SimpleStorage),
    V010008(crate::simple_storage::v1_0_8::SimpleStorage),
...
pub mod v1_0_8 {
    ...
    pub struct SimpleStorage {
        ...
        pub devices: Option<Vec<crate::simple_storage::v1_0_8::Device>>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(rename = "Name")]
        pub name: String,
...
pub mod v1_1_6 {
    ...
    pub struct SimpleStorage {
        ...
        pub description: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Devices")]
        pub devices: Option<Vec<crate::simple_storage::v1_1_6::Device>>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(rename = "Name")]
        pub name: String,
...
pub mod v1_2_4 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::simple_storage::v1_2_4::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Device {
        #[serde(skip_serializing_if = "Option::is_none", rename = "CapacityBytes")]
    ...
    pub struct SimpleStorage {
        ...
        pub actions: Option<crate::simple_storage::v1_2_4::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Devices")]
        pub devices: Option<Vec<crate::simple_storage::v1_2_4::Device>>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::simple_storage::v1_2_4::Links>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,

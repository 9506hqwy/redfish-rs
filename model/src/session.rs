pub type Session = crate::session::v1_8_0::Session;
pub mod v1_8_0 {
    use serde::{Deserialize, Serialize};
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::session::v1_8_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Links {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
    ...
    pub struct Session {
        ...
        pub actions: Option<crate::session::v1_8_0::Actions>,
        #[serde(
        ...
        pub description: Option<crate::session::v1_8_0::SessionDescription>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "ExpirationTime")]
        pub expiration_time: Option<String>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::session::v1_8_0::Links>,
        #[serde(rename = "Name")]
        pub name: String,
        ...
        pub session_type: Option<crate::session::v1_8_0::SessionSessionType>,
    ...
    pub enum SessionDescription {
        V000001(crate::session::v1_8_0::SessionDescriptionN1),
    ...
    pub enum SessionSessionType {
        V010800(crate::session::v1_8_0::SessionTypes),
        V000001(crate::session::v1_8_0::SessionSessionTypeN1),
    }

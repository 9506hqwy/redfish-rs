pub type ThermalEquipment = crate::thermal_equipment::v1_2_0::ThermalEquipment;
pub mod v1_2_0 {
    use serde::{Deserialize, Serialize};
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::thermal_equipment::v1_2_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct ThermalEquipment {
        ...
        pub actions: Option<crate::thermal_equipment::v1_2_0::Actions>,
        ...
        pub description: Option<crate::thermal_equipment::v1_2_0::ThermalEquipmentDescription>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", rename = "RPUs")]
        pub rp_us: Option<crate::odata_v4::IdRef>,
    ...
    pub enum ThermalEquipmentDescription {
        V000001(crate::thermal_equipment::v1_2_0::ThermalEquipmentDescriptionN1),

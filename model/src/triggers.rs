...
#[serde(untagged)]
pub enum Triggers {
    V010301(crate::triggers::v1_3_1::Triggers),
    V010201(crate::triggers::v1_2_1::Triggers),
    V010105(crate::triggers::v1_1_5::Triggers),
    V010007(crate::triggers::v1_0_7::Triggers),
...
pub mod v1_0_7 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::triggers::v1_0_7::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct Threshold {
        ...
        pub activation: Option<crate::triggers::v1_0_7::ThresholdActivation>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "DwellTime")]
        pub dwell_time: Option<String>,
    ...
    pub struct Thresholds {
        ...
        pub lower_critical: Option<crate::triggers::v1_0_7::Threshold>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LowerWarning")]
        pub lower_warning: Option<crate::triggers::v1_0_7::Threshold>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "UpperCritical")]
        pub upper_critical: Option<crate::triggers::v1_0_7::Threshold>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "UpperWarning")]
        pub upper_warning: Option<crate::triggers::v1_0_7::Threshold>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct Triggers {
        ...
        pub actions: Option<crate::triggers::v1_0_7::Actions>,
        ...
        pub discrete_trigger_condition:
            Option<crate::triggers::v1_0_7::DiscreteTriggerConditionEnum>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "DiscreteTriggers")]
        pub discrete_triggers: Option<Vec<crate::triggers::v1_0_7::DiscreteTrigger>>,
        #[serde(rename = "Id")]
        pub id: String,
        ...
        pub metric_type: Option<crate::triggers::v1_0_7::MetricTypeEnum>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "NumericThresholds")]
        pub numeric_thresholds: Option<crate::triggers::v1_0_7::Thresholds>,
        ...
        pub trigger_actions: Option<Vec<crate::triggers::v1_0_7::TriggerActionEnum>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Wildcards")]
        pub wildcards: Option<Vec<crate::triggers::v1_0_7::Wildcard>>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Wildcard {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Name")]
...
pub mod v1_1_5 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::triggers::v1_1_5::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum DirectionOfCrossingEnum {
        #[default]
    ...
    pub struct Threshold {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Activation")]
        pub activation: Option<crate::triggers::v1_1_5::ThresholdActivation>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "DwellTime")]
        pub dwell_time: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Reading")]
        pub reading: Option<f64>,
    ...
    pub struct Thresholds {
        #[serde(skip_serializing_if = "Option::is_none", rename = "LowerCritical")]
        pub lower_critical: Option<crate::triggers::v1_1_5::Threshold>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LowerWarning")]
        pub lower_warning: Option<crate::triggers::v1_1_5::Threshold>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "UpperCritical")]
        pub upper_critical: Option<crate::triggers::v1_1_5::Threshold>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "UpperWarning")]
        pub upper_warning: Option<crate::triggers::v1_1_5::Threshold>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum TriggerActionEnum {
        #[default]
    ...
    pub struct Triggers {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::triggers::v1_1_5::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub discrete_trigger_condition:
            Option<crate::triggers::v1_1_5::DiscreteTriggerConditionEnum>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "DiscreteTriggers")]
        pub discrete_triggers: Option<Vec<crate::triggers::v1_1_5::DiscreteTrigger>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "EventTriggers")]
        pub event_triggers: Option<Vec<String>>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::triggers::v1_1_5::Links>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MetricProperties")]
        pub metric_properties: Option<Vec<String>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MetricType")]
        pub metric_type: Option<crate::triggers::v1_1_5::MetricTypeEnum>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "NumericThresholds")]
        pub numeric_thresholds: Option<crate::triggers::v1_1_5::Thresholds>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.etag")]
        pub odata_etag: Option<String>,
        ...
        pub status: Option<crate::resource::Status>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "TriggerActions")]
        pub trigger_actions: Option<Vec<crate::triggers::v1_1_5::TriggerActionEnum>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Wildcards")]
        pub wildcards: Option<Vec<crate::triggers::v1_1_5::Wildcard>>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Wildcard {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Name")]
...
pub mod v1_2_1 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::triggers::v1_2_1::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum DirectionOfCrossingEnum {
        #[default]
    ...
    pub struct Threshold {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Activation")]
        pub activation: Option<crate::triggers::v1_2_1::ThresholdActivation>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "DwellTime")]
        pub dwell_time: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Reading")]
        pub reading: Option<f64>,
    ...
    pub struct Thresholds {
        #[serde(skip_serializing_if = "Option::is_none", rename = "LowerCritical")]
        pub lower_critical: Option<crate::triggers::v1_2_1::Threshold>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "LowerWarning")]
        pub lower_warning: Option<crate::triggers::v1_2_1::Threshold>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "UpperCritical")]
        pub upper_critical: Option<crate::triggers::v1_2_1::Threshold>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "UpperWarning")]
        pub upper_warning: Option<crate::triggers::v1_2_1::Threshold>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum TriggerActionEnum {
        #[default]
    ...
    pub struct Triggers {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::triggers::v1_2_1::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub discrete_trigger_condition:
            Option<crate::triggers::v1_2_1::DiscreteTriggerConditionEnum>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "DiscreteTriggers")]
        pub discrete_triggers: Option<Vec<crate::triggers::v1_2_1::DiscreteTrigger>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "EventTriggers")]
        pub event_triggers: Option<Vec<String>>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::triggers::v1_2_1::Links>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MetricIds")]
        pub metric_ids: Option<Vec<String>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MetricProperties")]
        pub metric_properties: Option<Vec<String>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MetricType")]
        pub metric_type: Option<crate::triggers::v1_2_1::MetricTypeEnum>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "NumericThresholds")]
        pub numeric_thresholds: Option<crate::triggers::v1_2_1::Thresholds>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.etag")]
        pub odata_etag: Option<String>,
        ...
        pub status: Option<crate::resource::Status>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "TriggerActions")]
        pub trigger_actions: Option<Vec<crate::triggers::v1_2_1::TriggerActionEnum>>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Wildcards")]
        pub wildcards: Option<Vec<crate::triggers::v1_2_1::Wildcard>>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Wildcard {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Name")]

...
pub enum TaskService {
    V010200(crate::task_service::v1_2_0::TaskService),
    V010106(crate::task_service::v1_1_6::TaskService),
    V010009(crate::task_service::v1_0_9::TaskService),
...
pub mod v1_0_9 {
    ...
    pub struct TaskService {
        ...
        pub completed_task_over_write_policy: Option<crate::task_service::v1_0_9::OverWritePolicy>,
...
pub mod v1_1_6 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::task_service::v1_1_6::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct TaskService {
        ...
        pub actions: Option<crate::task_service::v1_1_6::Actions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "CompletedTaskOverWritePolicy"
        )]
        pub completed_task_over_write_policy: Option<crate::task_service::v1_1_6::OverWritePolicy>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "DateTime")]
        pub date_time: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,

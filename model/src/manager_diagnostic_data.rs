pub type ManagerDiagnosticData = crate::manager_diagnostic_data::v1_2_1::ManagerDiagnosticData;
pub mod v1_2_0 {
...
pub mod v1_2_1 {
    ...
    pub struct Actions {
        ...
        pub manager_diagnostic_data_reset_metrics:
            Option<crate::manager_diagnostic_data::v1_2_1::ResetMetrics>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::manager_diagnostic_data::v1_2_1::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct BootTimeStatistics {
        #[serde(
    ...
    pub struct ManagerDiagnosticData {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::manager_diagnostic_data::v1_2_1::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "BootTimeStatistics")]
        pub boot_time_statistics:
            Option<crate::manager_diagnostic_data::v1_2_1::BootTimeStatistics>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub free_storage_space_kib: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "I2CBuses")]
        pub i2c_buses: Option<Vec<crate::manager_diagnostic_data::v1_2_1::I2CBusStatistics>>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub memory_ecc_statistics:
            Option<crate::manager_diagnostic_data::v1_2_1::MemoryECCStatistics>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "MemoryStatistics")]
        pub memory_statistics: Option<crate::manager_diagnostic_data::v1_2_1::MemoryStatistics>,
        #[serde(rename = "Name")]
        pub name: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "@odata.context")]
        pub odata_context: Option<String>,
        ...
        pub processor_statistics:
            Option<crate::manager_diagnostic_data::v1_2_1::ProcessorStatistics>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "ServiceRootUptimeSeconds"
        )]
        pub service_root_uptime_seconds: Option<f64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "TopProcesses")]
        pub top_processes: Option<Vec<crate::manager_diagnostic_data::v1_2_1::ProcessStatistics>>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct MemoryECCStatistics {
        #[serde(

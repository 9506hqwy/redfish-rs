...
pub enum PowerDistribution {
    V010301(crate::power_distribution::v1_3_1::PowerDistribution),
    V010203(crate::power_distribution::v1_2_3::PowerDistribution),
    V010103(crate::power_distribution::v1_1_3::PowerDistribution),
    V010006(crate::power_distribution::v1_0_6::PowerDistribution),
...
pub mod v1_0_6 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::power_distribution::v1_0_6::OemActions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#PowerDistribution.TransferControl"
        )]
        pub power_distribution_transfer_control:
            Option<crate::power_distribution::v1_0_6::TransferControl>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Links {
    ...
    pub struct PowerDistribution {
        ...
        pub actions: Option<crate::power_distribution::v1_0_6::Actions>,
        ...
        pub equipment_type: crate::power_distribution::v1_0_6::PowerEquipmentType,
        ...
        pub links: Option<crate::power_distribution::v1_0_6::Links>,
        ...
        pub transfer_configuration:
            Option<crate::power_distribution::v1_0_6::TransferConfiguration>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "TransferCriteria")]
        pub transfer_criteria: Option<crate::power_distribution::v1_0_6::TransferCriteria>,
    ...
    pub struct TransferCriteria {
        ...
        pub transfer_sensitivity:
            Option<crate::power_distribution::v1_0_6::TransferSensitivityType>,
        #[serde(
            skip_serializing_if = "Option::is_none",
...
pub mod v1_1_3 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::power_distribution::v1_1_3::OemActions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#PowerDistribution.TransferControl"
        )]
        pub power_distribution_transfer_control:
            Option<crate::power_distribution::v1_1_3::TransferControl>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Links {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Chassis")]
    ...
    pub struct PowerDistribution {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::power_distribution::v1_1_3::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "AssetTag")]
        pub asset_tag: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Branches")]
        pub branches: Option<crate::odata_v4::IdRef>,
        ...
        pub description: Option<String>,
        #[serde(rename = "EquipmentType")]
        pub equipment_type: crate::power_distribution::v1_1_3::PowerEquipmentType,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Feeders")]
        pub feeders: Option<crate::odata_v4::IdRef>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "FirmwareVersion")]
        pub firmware_version: Option<String>,
        ...
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::power_distribution::v1_1_3::Links>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Location")]
        pub location: Option<crate::resource::Location>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Mains")]
        pub mains: Option<crate::odata_v4::IdRef>,
        ...
        pub transfer_configuration:
            Option<crate::power_distribution::v1_1_3::TransferConfiguration>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "TransferCriteria")]
        pub transfer_criteria: Option<crate::power_distribution::v1_1_3::TransferCriteria>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "UUID")]
        pub uuid: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Version")]
        pub version: Option<String>,
    ...
    pub struct TransferCriteria {
        ...
        pub transfer_sensitivity:
            Option<crate::power_distribution::v1_1_3::TransferSensitivityType>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "UnderNominalFrequencyHz"
        )]
...
pub mod v1_2_3 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::power_distribution::v1_2_3::OemActions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#PowerDistribution.TransferControl"
        )]
        pub power_distribution_transfer_control:
            Option<crate::power_distribution::v1_2_3::TransferControl>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Links {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Chassis")]
    ...
    pub struct PowerDistribution {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::power_distribution::v1_2_3::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "AssetTag")]
        pub asset_tag: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Branches")]
        pub branches: Option<crate::odata_v4::IdRef>,
        ...
        pub description: Option<String>,
        #[serde(rename = "EquipmentType")]
        pub equipment_type: crate::power_distribution::v1_2_3::PowerEquipmentType,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Feeders")]
        pub feeders: Option<crate::odata_v4::IdRef>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "FirmwareVersion")]
        pub firmware_version: Option<String>,
        ...
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::power_distribution::v1_2_3::Links>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Location")]
        pub location: Option<crate::resource::Location>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Mains")]
        pub mains: Option<crate::odata_v4::IdRef>,
        ...
        pub transfer_configuration:
            Option<crate::power_distribution::v1_2_3::TransferConfiguration>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "TransferCriteria")]
        pub transfer_criteria: Option<crate::power_distribution::v1_2_3::TransferCriteria>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "UUID")]
        pub uuid: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Version")]
        pub version: Option<String>,
    ...
    pub struct TransferCriteria {
        ...
        pub transfer_sensitivity:
            Option<crate::power_distribution::v1_2_3::TransferSensitivityType>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "UnderNominalFrequencyHz"
        )]

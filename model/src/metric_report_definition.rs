...
pub mod v1_4_6 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::metric_report_definition::v1_4_6::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct Metric {
        ...
        pub collection_function:
            Option<crate::metric_report_definition::v1_4_6::MetricCollectionFunction>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "CollectionTimeScope"
        )]
        pub collection_time_scope:
            Option<crate::metric_report_definition::v1_4_6::MetricCollectionTimeScope>,
    ...
    pub enum MetricCollectionFunction {
        V010406(crate::metric_report_definition::v1_4_6::CalculationAlgorithmEnum),
        V000001(crate::metric_report_definition::v1_4_6::MetricCollectionFunctionN1),
    }
    impl Default for MetricCollectionFunction {
        fn default() -> Self {
            Self::V010406(Default::default())
        }
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub enum MetricCollectionTimeScope {
        V010406(crate::metric_report_definition::v1_4_6::CollectionTimeScope),
        V000001(crate::metric_report_definition::v1_4_6::MetricCollectionTimeScopeN1),
    }
    ...
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct MetricReportDefinition { # [serde (skip_serializing_if = "Option::is_none" , rename = "Actions")] pub actions : Option < crate :: metric_report_definition :: v1_4_6 :: Actions > , # [serde (skip_serializing_if = "Option::is_none" , rename = "AppendLimit")] pub append_limit : Option < i64 > , # [serde (skip_serializing_if = "Option::is_none" , rename = "Description")] pub description : Option < crate :: metric_report_definition :: v1_4_6 :: MetricReportDefinitionDescription > , # [serde (rename = "Id")] pub id : String , # [serde (skip_serializing_if = "Option::is_none" , rename = "Links")] pub links : Option < crate :: metric_report_definition :: v1_4_6 :: Links > , # [serde (skip_serializing_if = "Option::is_none" , rename = "MetricProperties")] pub metric_properties : Option < Vec < String > > , # [serde (skip_serializing_if = "Option::is_none" , rename = "MetricReport")] pub metric_report : Option < crate :: odata_v4 :: IdRef > , # [serde (skip_serializing_if = "Option::is_none" , rename = "MetricReportDefinitionEnabled")] pub metric_report_definition_enabled : Option < bool > , # [serde (skip_serializing_if = "Option::is_none" , rename = "MetricReportDefinitionType")] pub metric_report_definition_type : Option < crate :: metric_report_definition :: v1_4_6 :: MetricReportDefinitionMetricReportDefinitionType > , # [serde (skip_serializing_if = "Option::is_none" , rename = "MetricReportHeartbeatInterval")] pub metric_report_heartbeat_interval : Option < String > , # [serde (skip_serializing_if = "Option::is_none" , rename = "Metrics")] pub metrics : Option < Vec < crate :: metric_report_definition :: v1_4_6 :: Metric > > , # [serde (rename = "Name")] pub name : String , # [serde (skip_serializing_if = "Option::is_none" , rename = "@odata.context")] pub odata_context : Option < String > , # [serde (skip_serializing_if = "Option::is_none" , rename = "@odata.etag")] pub odata_etag : Option < String > , # [serde (rename = "@odata.id")] pub odata_id : String , # [serde (rename = "@odata.type")] pub odata_type : String , # [serde (skip_serializing_if = "Option::is_none" , rename = "Oem")] pub oem : Option < crate :: resource :: Oem > , # [serde (skip_serializing_if = "Option::is_none" , rename = "ReportActions")] pub report_actions : Option < Vec < crate :: metric_report_definition :: v1_4_6 :: ReportActionsEnum > > , # [serde (skip_serializing_if = "Option::is_none" , rename = "ReportTimespan")] pub report_timespan : Option < String > , # [serde (skip_serializing_if = "Option::is_none" , rename = "ReportUpdates")] pub report_updates : Option < crate :: metric_report_definition :: v1_4_6 :: ReportUpdatesEnum > , # [serde (skip_serializing_if = "Option::is_none" , rename = "Schedule")] pub schedule : Option < crate :: schedule :: Schedule > , # [serde (skip_serializing_if = "Option::is_none" , rename = "Status")] pub status : Option < crate :: resource :: Status > , # [serde (skip_serializing_if = "Option::is_none" , rename = "SuppressRepeatedMetricValue")] pub suppress_repeated_metric_value : Option < bool > , # [serde (skip_serializing_if = "Option::is_none" , rename = "Wildcards")] pub wildcards : Option < Vec < crate :: metric_report_definition :: v1_4_6 :: Wildcard > > }
    #[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
    #[serde(untagged)]
    pub enum MetricReportDefinitionDescription {
        V000001(crate::metric_report_definition::v1_4_6::MetricReportDefinitionDescriptionN1),
    ...
    pub enum MetricReportDefinitionMetricReportDefinitionType {
        V010406 (crate :: metric_report_definition :: v1_4_6 :: MetricReportDefinitionType) , V000001 (crate :: metric_report_definition :: v1_4_6 :: MetricReportDefinitionMetricReportDefinitionTypeN1) }

pub type Filter = crate::filter::v1_1_0::Filter;
pub mod v1_1_0 {
    use serde::{Deserialize, Serialize};
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::filter::v1_1_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Filter {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::filter::v1_1_0::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Assembly")]
        pub assembly: Option<crate::odata_v4::IdRef>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "DeltaLiquidPressurekPa"
        )]
        pub delta_liquid_pressurek_pa: Option<crate::filter::v1_1_0::FilterDeltaLiquidPressurekPa>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::filter::v1_1_0::FilterDescription>,
    ...
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub enum FilterDeltaLiquidPressurekPaN1 {
        #[default]
        #[serde(rename = "null")]
        Null,
    }
    ...
    pub enum FilterDescription {
        V000001(crate::filter::v1_1_0::FilterDescriptionN1),

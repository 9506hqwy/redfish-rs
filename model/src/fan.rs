pub type Fan = crate::fan::v1_6_0::Fan;
pub mod v1_5_2 {
    ...
    pub enum FanSecondarySpeedPercent {
        ...
        SensorSensorFanExcerpt(crate::sensor::v1_9_3::SensorFanExcerpt),
    }
...
pub mod v1_6_0 {
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::fan::v1_6_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Fan {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::fan::v1_6_0::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Assembly")]
        pub assembly: Option<crate::odata_v4::IdRef>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<crate::fan::v1_6_0::FanDescription>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "FanDiameterMm")]
        pub fan_diameter_mm: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "HotPluggable")]
        pub hot_pluggable: Option<bool>,
        ...
        pub id: String,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Links")]
        pub links: Option<crate::fan::v1_6_0::Links>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Location")]
        pub location: Option<crate::resource::Location>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub physical_context: Option<crate::physical_context::PhysicalContext>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "PowerWatts")]
        pub power_watts: Option<crate::fan::v1_6_0::FanPowerWatts>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "RatedSecondarySpeedRPM"
        )]
        pub rated_secondary_speed_rpm: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "RatedSpeedRPM")]
        pub rated_speed_rpm: Option<i64>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Replaceable")]
        pub replaceable: Option<bool>,
        #[serde(
            skip_serializing_if = "Option::is_none",
        ...
        pub secondary_speed_percent: Option<crate::fan::v1_6_0::FanSecondarySpeedPercent>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SerialNumber")]
        pub serial_number: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SparePartNumber")]
        pub spare_part_number: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "SpeedPercent")]
        pub speed_percent: Option<crate::fan::v1_6_0::FanSpeedPercent>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Status")]
        pub status: Option<crate::resource::Status>,
    }
    #[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
    #[serde(untagged)]
    pub enum FanDescription {
        V000001(crate::fan::v1_6_0::FanDescriptionN1),
        ResourceDescription(String),
    }
    impl Default for FanDescription {
        fn default() -> Self {
    ...
    #[serde(untagged)]
    pub enum FanPowerWatts {
        V000001(crate::fan::v1_6_0::FanPowerWattsN1),
        SensorSensorPowerExcerpt(crate::sensor::v1_9_3::SensorPowerExcerpt),
    }
    impl Default for FanPowerWatts {
        fn default() -> Self {
    ...
    #[serde(untagged)]
    pub enum FanSecondarySpeedPercent {
        V000001(crate::fan::v1_6_0::FanSecondarySpeedPercentN1),
        SensorSensorFanExcerpt(crate::sensor::v1_9_3::SensorFanExcerpt),
    }
    impl Default for FanSecondarySpeedPercent {
        fn default() -> Self {
    ...
    #[serde(untagged)]
    pub enum FanSpeedPercent {
        V000001(crate::fan::v1_6_0::FanSpeedPercentN1),
        SensorSensorFanExcerpt(crate::sensor::v1_9_3::SensorFanExcerpt),
    }
    impl Default for FanSpeedPercent {
        fn default() -> Self {

...
#[serde(untagged)]
pub enum ThermalMetrics {
    V010200(crate::thermal_metrics::v1_2_0::ThermalMetrics),
    V010100(crate::thermal_metrics::v1_1_0::ThermalMetrics),
    V010001(crate::thermal_metrics::v1_0_1::ThermalMetrics),
...
pub mod v1_0_1 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::thermal_metrics::v1_0_1::OemActions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#ThermalMetrics.ResetMetrics"
        )]
        pub thermal_metrics_reset_metrics: Option<crate::thermal_metrics::v1_0_1::ResetMetrics>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct ThermalMetrics {
        ...
        pub actions: Option<crate::thermal_metrics::v1_0_1::Actions>,
        ...
        pub temperature_summary_celsius: Option<crate::thermal_metrics::v1_0_1::TemperatureSummary>,
    }
}
pub mod v1_1_0 {
    use serde::{Deserialize, Serialize};
    ...
    pub struct Actions {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Oem")]
        pub oem: Option<crate::thermal_metrics::v1_1_0::OemActions>,
        #[serde(
            skip_serializing_if = "Option::is_none",
            rename = "#ThermalMetrics.ResetMetrics"
        )]
        pub thermal_metrics_reset_metrics: Option<crate::thermal_metrics::v1_1_0::ResetMetrics>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    ...
    pub struct ThermalMetrics {
        #[serde(skip_serializing_if = "Option::is_none", rename = "Actions")]
        pub actions: Option<crate::thermal_metrics::v1_1_0::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "HeaterSummary")]
        pub heater_summary: Option<crate::thermal_metrics::v1_1_0::HeaterSummary>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(rename = "Name")]
        pub name: String,
        ...
        pub temperature_summary_celsius: Option<crate::thermal_metrics::v1_1_0::TemperatureSummary>,
    }
}
pub mod v1_2_0 {
    use serde::{Deserialize, Serialize};

...
#[serde(untagged)]
pub enum LogEntryCollectionDescription {
    V000001(crate::log_entry_collection::LogEntryCollectionDescriptionN1),
    ResourceDescription(String),
}
impl Default for LogEntryCollectionDescription {
    fn default() -> Self {
        Self::V000001(Default::default())
    }
}
#[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
pub enum LogEntryCollectionDescriptionN1 {
    #[default]
    #[serde(rename = "null")]
    Null,
}

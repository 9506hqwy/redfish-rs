...
pub enum NetworkDeviceFunctionMetrics {
    V010100(crate::network_device_function_metrics::v1_1_0::NetworkDeviceFunctionMetrics),
    V010000(crate::network_device_function_metrics::v1_0_0::NetworkDeviceFunctionMetrics),
...
pub mod v1_0_0 {
    ...
    pub struct Actions {
        ...
        pub oem: Option<crate::network_device_function_metrics::v1_0_0::OemActions>,
    }
    #[derive(Clone, Debug, Default, Deserialize, PartialEq, Serialize)]
    pub struct Ethernet {
        #[serde(
    ...
    pub struct NetworkDeviceFunctionMetrics {
        ...
        pub actions: Option<crate::network_device_function_metrics::v1_0_0::Actions>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Description")]
        pub description: Option<String>,
        #[serde(skip_serializing_if = "Option::is_none", rename = "Ethernet")]
        pub ethernet: Option<crate::network_device_function_metrics::v1_0_0::Ethernet>,
        #[serde(rename = "Id")]
        pub id: String,
        #[serde(rename = "Name")]
        pub name: String,
